...
const coverExitTransitionMs = 620;
...
async function hideLoading() {
  ...
  // Keep the handoff deliberately simple: the canonical cover class owns
  // the short visual fade and pointer release. No inert/ARIA/host mutation,
  // hit-test probing, or forced fallback removal participates in input.
