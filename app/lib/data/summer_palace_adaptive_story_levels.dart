...
const summerPalaceN1SemanticEvents = <SummerPalaceN1SemanticEvent>[
  ...
  SummerPalaceN1SemanticEvent(
    ...
    detailChinese: '她等的不是夕阳，而是桥洞被落日逐渐照亮的短暂时刻。',
    detailPinyin: 'Tā děng de bú shì xīyáng, ér shì qiáodòng bèi luòrì zhújiàn zhàoliàng de duǎnzàn shíkè.',
    detailVietnamese: 'Điều cô chờ không phải hoàng hôn mà là khoảnh khắc ngắn khi nắng lặn dần chiếu sáng các vòm cầu.',
    detailEnglish: 'She is not waiting for sunset but for the brief moment when the setting sun gradually illuminates the bridge arches.',
    detailFromLevel: 6,
  ),
  SummerPalaceN1SemanticEvent(
