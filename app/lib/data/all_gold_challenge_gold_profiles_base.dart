...
const nonDatongGoldChallengeProfiles = <String, GoldChallengeProfile>{
  ...
  'xian-city-wall': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['必须就先', '先必须', '必须所以先'],
  ...
  'hangzhou-west-lake': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>[
          '不在景名是否答对，而在如何一起面对记忆变化',
          '不是于景名是否答对，而是在于如何一起面对记忆变化',
          '不在于景名是否答对，而是在如何一起面对记忆变化',
        ],
  ...
  'chengdu-kuanzhai-alley': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['先门口把竹椅', '把门口的竹椅先', '先把竹椅的门口'],
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['是所以', '所以是因为', '是因为所以'],
  ...
  'guangzhou-chen-clan-academy': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['手机慢慢地举起', '慢慢的举起手机', '慢慢得举起手机'],
        errorType: '地点与方式语序',
  ...
  'luoyang-longmen-grottoes': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['先自己按想象', '先自己的想象按', '先按自己想象的'],
        errorType: '状语语序',
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['足以只支持有限判断，而且能', '只能支持有限判断，却能', '只支持有限判断，所以足以'],
  ...
  'lijiang-old-town': GoldChallengeProfile(
  ...
  'jiangmen-kaiping-diaolou': GoldChallengeProfile(
    ...
    grammar: <GoldChallengeGrammarSpec>[
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['寄回从海外一份', '从海外一份寄回', '从海外寄了一份回'],
        errorType: '数量与状语语序',
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['这个所以让', '这所以让', '因为这让'],
      ...
      GoldChallengeGrammarSpec(
        ...
        distractors: <String>['围绕到', '围绕在', '围绕着到'],
