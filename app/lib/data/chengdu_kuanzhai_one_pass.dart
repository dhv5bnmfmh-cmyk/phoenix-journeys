...
final chengduKuanzhaiOnePassLevels = List<JourneyLevelContent>.unmodifiable([
  ...
  _chengduLevel(10, [
    ...
    '她没有把周叔的喝茶、服务员的往返或访客的通行判成不合理。真正冲突的是院落入口的有限空间与不断变化的使用时序：同一小块地方不能永久交给一种用途，却可以在不同时间服务不同的人。林夏放弃给竹椅指定永久归属，改成亲手建立交接节奏。她先示范：有人从巷子进院，竹椅就退出门槛；通道清空，椅子再回到茶桌。她邀请周叔一起留意下一次需要，谁先看见，谁先移动，不必等她发令。起初周叔仍看她一眼才动，后来服务员端茶、客人离院、另一桌有人经过，竹椅反复几次让位又归还，动作越来越自然。傍晚前，一名第一次来的客人从街巷转入院门，林夏正在另一桌添水，背对入口。周叔先看见来人，没有喊她，也没有等提示，自己起身把竹椅挪到院墙边；客人跨过门槛进入院落后，他又把椅子推回茶桌旁，继续喝茶。林夏转身时只看见已经打开又恢复的通路。她没有再伸手，也没有把椅子校正到某个标准点。茶客继续停留，服务人员继续穿行，院落在一轮轮临时交接中保持可用。最后，一位离桌的客人顺手又为经过的人移开同一把竹椅。林夏看着那只手完成动作，没有出声。一把没有固定位置的竹椅，已经把共享空间的节奏交给了下一位使用者。'
  ]),
]);
