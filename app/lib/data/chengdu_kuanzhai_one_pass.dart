...
final chengduKuanzhaiOnePassLevels = List<JourneyLevelContent>.unmodifiable([
  ...
  _chengduLevel(4, [
    ...
    '林夏没有把通行或喝茶中的任何一方当成麻烦。她试着换问题：不是“椅子应该永远放哪儿”，而是“现在这几分钟谁需要这块地方”。她和周叔约定，门口有人进出时就把竹椅让开，通道恢复后再交还给茶桌；谁先看见下一次需要，谁就先动手。第二轮交接后，周叔已经不再等她提醒。下午又有客人跨过门槛，林夏正端着水壶，周叔先起身把竹椅挪到一旁；客人通过后，他又把椅子推回茶桌边。林夏犹豫了一下，没有重新摆正它。院落在停留和通行之间继续转换，一把没有固定位置的竹椅把这种临时交接留在动作里。'
  ]),
  _chengduLevel(5, [
  ...
  _chengduLevel(8, [
    ...
    '林夏没有把冲突解释成谁更有资格占这个位置。喝茶的停留、服务员的往返、访客的进出都合理，真正变化的是发生的时刻。她不再寻找一张永久布局，而是和周叔商量一个简单的临时交接：入口开始通行时，竹椅先退出通道；门槛空下来，再让它回到茶桌；下一次谁先看到需要，谁就先动手。最初林夏仍会下意识伸手，随后她故意慢半拍，让周叔参与。服务员端水出去时，周叔移椅；一桌客人离院后，他又把椅子放回。这个动作不是写在纸上的规定，而是在院门、门槛、茶桌与人的身体之间一次次被练出来。傍晚前，一名第一次来的客人从宽巷子一侧走近院门，林夏正给另一桌添茶，完全没有发出指令。周叔看见来人，自己起身把竹椅移到墙边；客人跨过门槛后，他顺手把椅子还给茶桌。林夏转过身，只看见通道已经重新打开。她没有接管，也没有把椅子搬回所谓标准位置。茶继续喝，服务继续穿行，一把没有固定位置的竹椅让院落形成了可以被别人接续的共享节奏。'
  ]),
  _chengduLevel(9, [
  ...
  _chengduLevel(10, [
    ...
    '院落里，林夏没有把周叔的喝茶、服务员的往返或访客的通行判成不合理。真正冲突的是院落入口的有限空间与不断变化的使用时序：同一小块地方不能永久交给一种用途，却可以在不同时间服务不同的人。林夏放弃给竹椅指定永久归属，改成亲手建立交接节奏。她先示范：有人从巷子进院，竹椅就退出门槛；通道清空，椅子再回到茶桌。她邀请周叔一起留意下一次需要，谁先看见，谁先移动，不必等她发令。起初周叔仍看她一眼才动，后来服务员端茶、客人离院、另一桌有人经过，竹椅反复几次让位又归还，动作越来越自然。傍晚前，一名第一次来的客人从街巷转入院门，林夏正在另一桌添水，背对入口。周叔先看见来人，没有喊她，也没有等提示，自己起身把竹椅挪到院墙边；客人跨过门槛进入院落后，他又把椅子推回茶桌旁，继续喝茶。林夏转身时只看见已经打开又恢复的通路。她没有再伸手，也没有把椅子校正到某个标准点。茶客继续停留，服务人员继续穿行，院落在一轮轮临时交接中保持可用。最后，一位离桌的客人顺手又为经过的人移开同一把竹椅。林夏看着那只手完成动作，没有出声。一把没有固定位置的竹椅，已经把共享空间的节奏交给了下一位使用者。'
  ]),
]);
