...
const longmenGoldStoryLevels = <LongmenStoryLevelSpec>[
  ...
  LongmenStoryLevelSpec(
    chinese: <String>[
      '父母搬离洛阳后，周岚和弟弟周屿共同拥有的旧房空了两年。水电、维修和中介电话大多由周岚处理，她渐渐习惯先决定，再通知弟弟。这个月她找到买家，又看中一套离公司更近的小房，没等周屿答应就交了不能退的定金。只要今天两个人签字，她就能把事情一次解决。周屿同意见面，却坚持先去龙门石窟。',
...
final longmenGoldDiscoveries = List<DiscoveryEntry>.unmodifiable(<DiscoveryEntry>[
  ...
  _longmenDiscovery('龙门同时包含小型佛龛、洞窟和大型造像群，观看者需要在近距离细节与较远的整体尺度之间不断切换。', 'Long Môn đồng thời có hốc thờ nhỏ, hang động và quần thể tượng lớn, nên người xem phải liên tục chuyển giữa chi tiết ở khoảng cách gần và quy mô tổng thể ở khoảng cách xa hơn.', 'Longmen contains small niches, caves, and monumental sculpture groups, requiring viewers to shift between close detail and the larger scale visible from farther away.'),
...
const longmenGoldWords = <WordEntry>[
  ...
  WordEntry(word: '代价', pinyin: 'dàijià', simpleChinese: '为了得到某种结果必须承担的损失。', translation: 'cái giá', englishDefinition: 'cost or price of a choice', symbol: '🪙'),
