...
const _segments = <_LijiangSegment>[
  _LijiangSegment(0, 1, '清末黄昏，四方街刚散市。商贩和清与姐姐和素守着一驮茶叶；明早买家离城，这笔钱要还两人共同的债。', 'Một buổi chiều cuối thời Thanh, chợ ở Tứ Phương vừa tan. Người buôn Hòa Thanh và chị gái Hòa Tố trông một chuyến trà; sáng mai người mua rời thành và số tiền này phải trả món nợ chung của hai chị em.', 'At dusk in the late Qing, the market at Sifang Street has just dispersed. The trader He Qing and his older sister He Su guard a mule-load of tea; the buyer leaves in the morning, and the sale must pay their shared debt.'),
  ...
  _LijiangSegment(0, 7, '下午，和清亲眼看着几支马帮从不同巷口挤进四方街。姐姐踮脚找了三次，才认出约好明早来收茶的人。', 'Chiều đó, Hòa Thanh tận mắt thấy vài đoàn ngựa, la chen vào phố Tứ Phương từ các ngõ khác nhau. Chị cậu phải kiễng chân tìm ba lần mới nhận ra người đã hẹn sáng mai tới nhận trà.', 'That afternoon, He Qing watches several caravans squeeze into Sifang Street from different lane mouths. His sister rises on tiptoe three times before recognizing the buyer due to collect the tea the next morning.'),
  ...
  _LijiangSegment(1, 8, '和清低头就看见桥下的水光。离火最近的几户已经把木桶拖到巷口，却被那驮横在桥上的茶挡住。', 'Hòa Thanh cúi xuống thấy ánh nước ngay dưới cầu. Những nhà gần đám cháy nhất đã kéo xô gỗ ra đầu ngõ, nhưng chuyến trà nằm ngang trên cầu chặn lối.', 'He Qing looks down and sees the water glint beneath the bridge. The households nearest the fire have dragged wooden buckets to the lane mouth, but the tea load lying across the bridge blocks them.'),
  ...
  _LijiangSegment(5, 9, '姐弟俩把没进水的茶搬到墙边。和素数到第五包时停了一下，把还能卖的那一包推到两人中间。', 'Hai chị em chuyển số trà chưa ngấm nước vào sát tường. Hòa Tố đếm đến bao thứ năm thì dừng lại và đẩy bao còn bán được vào khoảng giữa hai người.', 'The siblings move the dry tea against the wall. He Su pauses at the fifth sack and pushes the one still saleable into the space between them.'),
