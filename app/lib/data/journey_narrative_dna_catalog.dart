...
import 'journey_narrative_dna_baseline_snapshot.dart'
    show JourneyNarrativeDnaRecord;

export 'journey_narrative_dna_baseline_snapshot.dart'
    show JourneyNarrativeDnaRecord;
...
const forbiddenCityRemediatedNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistArchetype: 'young-heritage-building-apprentice-revising-route-judgment-through-evidence',
  openingSituation: 'familiar-central-axis-route-is-mistaken-for-the-only-correct-route-before-A-Ning-arrives-from-the-east',
  storyGoal: 'make-palace-spatial-relations-readable-without-erasing-task-dependent-route-differences',
  locationMechanism: 'Meridian-Gate-central-axis-Outer-Court-Inner-Court-Gate-of-Heavenly-Purity-and-east-side-connections-form-the-shared-spatial-framework',
  movementPattern: 'central-axis-observation-and-east-side-task-route-meet-at-Gate-of-Heavenly-Purity-then-are-compared-and-layered',
  conflictType: 'single-authoritative-route-model-vs-coexisting-role-and-purpose-dependent-routes',
  choiceType:
      'preserve-both-valid-routes-and-label-their-task-conditions-on-one-map',
  climaxType: 'shared-architectural-evidence-forces-route-judgment-revision-at-the-common-node',
  consequenceType:
      'coauthored-map-keeps-two-routes-and-their-validity-conditions-visible',
  emotionalArc: 'single-line-certainty-to-judgment-to-evidence-check-to-reciprocal-respect-to-coauthorship',
  historicalLearningMechanism: 'verified-axis-gate-courtyard-Outer-Inner-Court-and-east-side-gate-relations-become-the-common-spatial-scaffold-for-fictional-route-comparison',
  resolutionType: 'two-task-dependent-routes-survive-one-common-evidence-test-without-being-collapsed',
  endingMechanism: 'Shen-Yan-and-A-Ning-co-sign-a-map-with-both-routes-and-their-conditions-legible',
  memoryAnchorType:
  ...
  rewardSymbolism: 'two-clearly-labeled-lines-represent-conditional-validity-and-reciprocal-interpretation',
  temporalPattern: 'single-study-day-without-external-countdown',
  supportingStructure: 'cross-role-peer-perspective-exchange-between-Shen-Yan-and-A-Ning-with-mentor-refusing-to-supply-the-answer',
  centralMetaphor: 'one-architectural-framework-can-support-multiple-valid-movement-logics-when-their-conditions-are-made-explicit',
  narrativeVoice: 'third-person-action-led-spatial-comparison',
  storyRhythm: 'route-assertion-peer-contradiction-evidence-check-mutual-correction-layered-map-coauthorship',
);
...
const chengduRemediatedNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistArchetype: 'young-courtyard-host-facilitating-changing-shared-use',
  openingSituation: 'one-bamboo-chair-immediately-contested-by-legitimate-tea-seating-and-courtyard-passage',
  storyGoal: 'keep-courtyard-usable-for-tea-staying-service-and-passage-without-permanent-exclusion',
  locationMechanism: 'Kuanzhai-street-lane-courtyard-threshold-compresses-stopping-and-circulation-into-one-shared-entry-zone',
  movementPattern: 'bamboo-chair-repeatedly-yields-from-threshold-to-wall-and-returns-to-tea-table',
  ...
  climaxType: 'older-regular-independently-clears-passage-and-restores-tea-seat-without-host-instruction',
  consequenceType: 'courtyard-remains-usable-through-repeated-sequential-handoffs-among-participants',
  emotionalArc: 'arranging-confidence-to-irritation-to-negotiation-to-hesitation-to-relief-and-trust',
  historicalLearningMechanism: 'verified-street-lane-courtyard-morphology-and-current-tea-use-create-the-spatial-constraint-while-factual-conservation-learning-stays-in-Discovery',
  resolutionType: 'repeated-spatial-handoffs-create-a-shared-use-protocol',
  endingMechanism: 'another-user-moves-the-same-chair-for-passage-while-Lin-Xia-does-not-intervene',
  memoryAnchorType: 'one-bamboo-chair-without-a-fixed-position',
  achievementType: 'shared-courtyard-rhythm-facilitator',
  rewardSymbolism: 'yield-and-return-motion-symbolizes-temporary-use-handoff-not-ownership-or-mentor-reward',
  temporalPattern: 'single-afternoon-use-cycle-without-external-countdown',
  supportingStructure: 'practical-courtyard-host-and-older-regular-negotiate-and-reproduce-handoffs-without-mentor-authority',
  centralMetaphor: 'shared-space-stays-usable-by-being-handed-on-rather-than-permanently-owned',
  narrativeVoice: 'third-person-action-led-courtyard-coordination',
  storyRhythm: 'place-chair-first-handoff-fixed-layout-fails-again-negotiate-repeat-independent-reproduction-release-control',
);

const hangzhouReopenedNarrativeDna = JourneyNarrativeDnaRecord(
  journeyId: 'hangzhou-west-lake',
  narrativeIdentity:
      'long-married-couple-end-hidden-memory-test-and-name-shared-fear',
  protagonistIdentity:
      'Fang-Yu-sixty-nine-year-old-wife-facing-husbands-memory-decline',
  protagonistAgeIdentity: 'sixty-nine-year-old-older-spouse',
  protagonistArchetype:
      'older-spouse-concealing-clinic-appointment-behind-familiar-walk',
  openingSituation: 'familiar-West-Lake-walk-is-secretly-used-as-memory-test-before-clinic-visit',
  storyGoal:
      'learn-what-husband-remembers-without-directly-naming-medical-fear',
  ...
  conflictType:
      'proof-seeking-memory-quiz-vs-honest-mutual-recognition-of-decline',
  choiceType: 'stop-testing-and-openly-hand-over-clinic-appointment',
  climaxType:
      'instinctive-elbow-catch-breaks-quiz-and-both-spouses-name-their-fear',
  consequenceType:
      'husband-keeps-appointment-card-and-asks-for-hospital-stop-himself',
  ...
  endingMechanism:
      'husband-asks-bus-driver-for-hospital-stop-with-card-in-own-wallet',
  ...
  supportingStructure:
      'long-married-spouses-each-conceal-fear-until-direct-mutual-admission',
  centralMetaphor:
      'a-shared-life-is-not-reducible-to-correct-place-name-answers',
...
const guangzhouChenClanGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistAgeIdentity:
      'sixty-one-year-old-mother-and-thirty-four-year-old-daughter',
  ...
  climaxType:
      'mother-denies-relatives-the-proof-she-has-wanted-for-thirty-four-years',
  ...
  supportingStructure:
      'estranged-birth-mother-and-adult-daughter-under-remote-kin-pressure',
...
const suzhouGardenGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistIdentity:
      'Chen-Yulan-grandmother-preparing-Cheng-Lang-for-independent-travel',
  protagonistAgeIdentity: 'older-grandmother-and-twelve-year-old-grandson',
  protagonistArchetype:
      'daily-caregiver-learning-to-release-immediate-visual-control',
  openingSituation:
      'last-Sunday-before-grandson-begins-travelling-to-school-alone',
  storyGoal:
      'let-grandson-walk-ahead-without-breaking-their-practical-care-bond',
  locationMechanism: 'garden-corridors-buildings-bridges-and-water-alternate-occlusion-with-reappearance',
  movementPattern:
      'grandson-walks-ahead-disappears-at-turns-and-waits-where-water-opens',
  conflictType:
      'protective-visual-control-vs-age-appropriate-independent-movement',
  ...
  resolutionType:
      'care-shifts-from-continuous-visibility-to-reciprocal-waiting',
  endingMechanism:
      'grandmother-says-next-place-wait-for-me-and-does-not-catch-up',
  memoryAnchorType:
      'raised-then-lowered-hand-and-grandson-looking-back-at-next-opening',
  ...
  supportingStructure:
      'grandmother-grandson-care-relationship-without-mentor-approval',
...
const summerPalaceCulturalIntegrationNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  climaxType:
      'seasonal-Seventeen-Arch-Bridge-light-shifts-during-photograph-retrieval',
  consequenceType:
      'desired-seasonal-shot-is-lost-and-cannot-be-recreated-that-moment',
  ...
  memoryAnchorType:
      'camera-lowered-as-old-photo-falls-during-moving-bridge-light',
  achievementType: 'place-grounded-relational-photographer',
  rewardSymbolism:
      'old-and-new-photographs-together-mark-trust-without-erasing-history',
  temporalPattern:
      'single-clear-winter-afternoon-with-expiring-seasonal-bridge-light',
...
const longmenGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistIdentity:
      'Lin-Yan-3D-creator-with-equal-source-collaborator-Zhou-Cheng',
  ...
  historicalLearningMechanism:
      'inscription-damage-and-old-photograph-bound-what-can-be-represented',
  resolutionType:
      'joint-authorship-survives-because-unsupported-completion-does-not',
  ...
  centralMetaphor:
      'an-empty-part-can-preserve-more-trust-than-a-seamless-invention',
...
const kaipingGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  narrativeIdentity: 'separated-brothers-reallocate-private-building-duty-into-communal-tower-use',
  protagonistIdentity: 'Liang-Chuan-fictional-young-local-brother-with-overseas-elder-brother-Liang-Hai',
  protagonistAgeIdentity:
      'fictional-young-local-brother-and-overseas-elder-brother',
  protagonistArchetype: 'local-brother-renegotiating-how-overseas-family-experience-serves-home-village-needs',
  openingSituation: 'overseas-brother-sends-design-and-contribution-conditioned-on-a-private-family-tower',
  storyGoal: 'decide-how-the-family-will-participate-in-a-building-choice-without-erasing-the-brothers-overseas-experience-or-local-communal-need',
  locationMechanism: 'Kaiping-communal-residential-watch-tower-functions-and-transnational-architectural-fusion-force-use-before-form',
  movementPattern: 'returned-sketch-moves-from-private-plan-to-revised-communal-plan-to-built-shared-interior-while-original-remains-unbuilt',
  conflictType: 'private-family-commemoration-and-conditioned-contribution-vs-multi-household-communal-refuge-use',
  choiceType: 'abandon-private-build-and-send-revised-communal-plan-with-promise-to-return-contribution',
  climaxType: 'overseas-brother-crosses-out-private-ownership-language-and-rewrites-family-share-as-part-of-communal-tower',
  consequenceType: 'communal-construction-continues-with-family-commitment-while-private-original-stays-unbuilt',
  emotionalArc: 'inherited-obligation-to-risk-of-rejection-to-written-renegotiation-to-reciprocal-recognition',
  historicalLearningMechanism: 'verified-Kaiping-tower-functional-differences-diaspora-ties-and-architectural-fusion-constrain-the-fictional-family-choice',
  resolutionType: 'transnational-family-duty-is-reallocated-through-communal-function-and-selective-local-recombination',
  endingMechanism: 'unbuilt-colonnade-and-surviving-entry-arch-remain-beside-the-faded-written-revision',
  memoryAnchorType: 'crossed-out-private-ownership-line-rewritten-as-the-family-share-in-a-communal-tower',
  achievementType: 'shared-family-duty-reframed-through-communal-use',
  rewardSymbolism: 'retained-arch-and-absent-colonnade-mark-selective-return-rather-than-literal-copy',
  temporalPattern: '1920s-fictional-building-choice-with-letter-reply-before-construction-commitment',
  supportingStructure: 'separated-brothers-negotiate-contribution-ownership-and-duty-through-letters-without-mentor-authority',
  centralMetaphor: 'what-returns-from-overseas-can-belong-at-home-without-being-copied-whole',
  narrativeVoice: 'third-person-close-to-fictional-local-brother-action-led',
  storyRhythm: 'conditional-sketch-communal-need-private-plan-risk-revision-letter-counter-revision-construction-selective-form-faded-ending',
);
...
const datongYungangGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  consequenceType:
      'sole-successor-title-is-lost-and-three-workers-mark-stone-independently',
  emotionalArc:
      'chosen-heir-certainty-to-relational-separation-to-accountable-equality',
  ...
  endingMechanism:
      'father-looks-back-at-three-black-lines-and-daughter-does-not-follow',
  memoryAnchorType: 'one-blackened-long-line-cut-into-three-on-a-stone-step',
  achievementType: 'distributed-craft-responsibility',
  rewardSymbolism:
      'three-separate-lines-mark-agency-without-a-generic-heritage-slogan',
  ...
  centralMetaphor:
      'a-scale-made-for-one-colossal-order-cannot-measure-three-futures',
...
const lijiangOldTownGoldNarrativeDna = JourneyNarrativeDnaRecord(
  journeyId: 'lijiang-old-town',
  narrativeIdentity:
      'jointly-owned-tea-is-destroyed-to-open-canal-bridge-for-emergency-water',
  protagonistIdentity: 'He-Qing-fictional-late-Qing-small-trader-sharing-tea-and-debt-with-older-sister',
  protagonistAgeIdentity:
      'fictional-adult-younger-brother-and-adult-older-sister',
  protagonistArchetype: 'small-trader-learning-that-shared-responsibility-is-not-the-same-as-unilateral-control',
  openingSituation: 'Sifang-market-has-dispersed-before-a-single-next-morning-sale-needed-to-pay-shared-debt',
  storyGoal: 'preserve-jointly-owned-tea-for-the-next-morning-buyer-and-clear-shared-debt',
  locationMechanism: 'verified-Lijiang-canal-bridge-timber-lane-and-caravan-market-configuration-makes-cargo-an-emergency-obstruction',
  movementPattern: 'loaded-mule-blocks-bridge-rope-is-cut-tea-falls-buckets-cross-wet-tea-returns-by-shared-pole',
  conflictType: 'joint-livelihood-asset-vs-immediate-emergency-access-with-conflicting-owner-authority',
  choiceType: 'cut-lashings-without-sisters-consent-and-accept-damage-to-both-owners-capital',
  climaxType:
      'last-rope-parts-tea-drops-and-first-usable-strip-of-bridge-opens',
  consequenceType: 'bucket-relay-crosses-bridge-fire-is-contained-in-fiction-while-sale-is-lost-and-debt-remains',
  emotionalArc: 'prove-I-can-decide-to-hesitation-over-shared-ownership-to-costly-action-to-jointly-borne-loss',
  historicalLearningMechanism: 'verified-water-used-for-fire-prevention-and-daily-life-combines-with-bridges-timber-buildings-and-Tea-Horse-commerce-to-make-the-fictional-private-choice-place-causal',
  resolutionType: 'shared-consequence-replaces-the-argument-over-who-gets-to-decide-without-verbal-reconciliation',
  endingMechanism: 'older-sister-shoulders-the-other-end-of-the-pole-and-shifts-the-wet-tea-weight-between-them',
  memoryAnchorType: 'lashings-snap-tea-rolls-into-water-bridge-opens-and-first-bucket-crosses',
  achievementType: 'reader-of-place-infrastructure-as-human-choice-pressure',
  rewardSymbolism: 'wet-tea-and-shared-carrying-weight-mark-irreversible-cost-and-joint-responsibility',
  temporalPattern: 'late-Qing-evening-after-market-close-through-dawn-before-an-uncertain-buyer',
  supportingStructure: 'older-sister-opposes-unilateral-loss-then-joins-bucket-relay-and-shares-cleanup-without-mentor-authority',
  centralMetaphor: 'when-the-bridge-must-open-the-weight-of-a-shared-life-does-not-disappear-it-moves-between-people',
  narrativeVoice: 'third-person-close-action-led-historical-fiction',
  storyRhythm: 'market-close-shared-debt-fire-blocked-bridge-owner-conflict-knife-hesitation-rope-cut-bucket-flow-wet-tea-shared-pole',
);

const hongheHaniRiceTerracesNarrativeDna = JourneyNarrativeDnaRecord(
  journeyId: 'honghe-hani-rice-terraces',
  narrativeIdentity: 'elected-water-keeper-restores-agreed-wooden-water-share-and-loses-private-buffalo-labor',
  protagonistIdentity: 'Luo-Qiu-fictional-contemporary-terrace-farmer-serving-first-round-as-community-water-keeper',
  protagonistAgeIdentity: 'fictional-adult-farmer',
  protagonistArchetype: 'ordinary-farmer-learning-that-public-water-duty-can-impose-private-reciprocity-cost',
  openingSituation: 'spring-irrigation-day-begins-with-first-public-ditch-round-and-private-buffalo-labor-arrangement',
  storyGoal: 'restore-agreed-branch-water-shares-while-finishing-own-final-terrace-with-neighbors-buffalo',
  locationMechanism: 'forest-fed-descending-shared-channels-and-negotiated-groove-widths-physically-distribute-water-among-terraces',
  movementPattern: 'forest-flow-to-village-channel-to-divider-groove-recut-to-downstream-terrace-while-buffalo-departs',
  conflictType: 'communal-water-allocation-duty-vs-private-reciprocal-labor-dependence-on-the-favored-neighbor',
  choiceType: 'restore-agreed-groove-width-immediately-instead-of-delaying-until-private-buffalo-help-is-finished',
  climaxType: 'recut-divider-seats-into-water-and-branch-flows-rebalance-as-neighbor-lifts-buffalo-rope',
  consequenceType: 'downstream-water-share-returns-while-protagonists-own-final-terrace-remains-unploughed-that-day',
  emotionalArc: 'routine-duty-confidence-to-recognition-of-private-leverage-to-hesitation-to-public-action-to-unreconciled-private-cost',
  historicalLearningMechanism: 'verified-wood-carved-water-allocation-community-water-keeper-role-and-forest-village-terrace-hydrology-make-the-fictional-private-conflict-place-causal',
  resolutionType: 'communal-allocation-is-restored-without-erasing-the-friendship-cost-or-rewarding-the-protagonist',
  endingMechanism: 'protagonist-works-her-own-unploughed-bund-by-foot-while-two-restored-channel-flows-continue-and-she-does-not-look-back',
  memoryAnchorType:
      'recut-hardwood-divider-separates-two-streams-as-buffalo-bell-turns-away',
  achievementType:
      'reader-of-living-water-governance-as-private-human-pressure',
  rewardSymbolism: 'two-different-water-sounds-and-absent-buffalo-mark-restored-public-share-with-private-cost',
  temporalPattern: 'single-contemporary-spring-irrigation-day-from-morning-ditch-round-to-dusk',
  supportingStructure: 'longtime-neighbor-and-labor-exchange-partner-asks-for-temporary-private-water-advantage-then-withdraws-promised-buffalo-without-mentor-authority',
  centralMetaphor: 'a-shared-flow-can-be-set-back-to-its-agreed-width-without-making-private-relationships-even-again',
  narrativeVoice: 'third-person-close-action-led-contemporary-cultural-fiction',
  storyRhythm: 'spring-round-private-help-plan-widened-groove-admission-private-leverage-hesitation-recut-divider-flow-return-buffalo-departure-own-field-work',
);
