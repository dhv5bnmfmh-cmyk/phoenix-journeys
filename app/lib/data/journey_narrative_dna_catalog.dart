...
const hangzhouReopenedNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  openingSituation:
      'familiar-West-Lake-walk-is-secretly-used-as-memory-test-before-clinic-visit',
  storyGoal:
      'learn-what-husband-remembers-without-directly-naming-medical-fear',
  locationMechanism:
      'named-seasonal-views-and-wet-Broken-Bridge-route-cue-conflicting-verbal-and-embodied-memory',
  ...
  emotionalArc:
      'concealment-to-testing-to-humiliation-to-embodied-recognition-to-mutual-admission',
  historicalLearningMechanism:
      'named-West-Lake-views-link-place-season-and-viewing-conditions-while-factual-cultural-landscape-learning-remains-in-Discovery',
  resolutionType:
      'medical-uncertainty-is-faced-through-disclosure-not-a-correct-memory-score',
  endingMechanism:
  ...
  rewardSymbolism:
      'wet-step-and-held-elbow-mark-embodied-care-not-project-success-or-separation',
  ...
  storyRhythm:
      'hidden-card-serial-questions-wrong-answers-silence-slip-catch-disclosure-card-accepted-bus-question',
);
...
const guangzhouChenClanGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistIdentity:
      'Chen-Xiuyi-sixty-one-year-old-birth-mother-meeting-adult-daughter-Liu-Jiahe',
  protagonistAgeIdentity:
      'sixty-one-year-old-mother-and-thirty-four-year-old-daughter',
  protagonistArchetype:
      'estranged-birth-mother-facing-cost-of-respecting-an-adult-childs-boundary',
  openingSituation:
      'first-private-meeting-after-thirty-four-years-with-no-relatives-and-no-reunion-photo-agreed',
  storyGoal:
      'continue-a-private-relationship-without-erasing-the-daughters-adoptive-name-and-life',
  locationMechanism:
      'jointly-funded-Chen-lineage-academy-plaque-and-layered-courtyards-intensify-public-surname-pressure',
  movementPattern:
      'private-entry-lineage-plaque-video-demand-phone-down-next-courtyard-side-by-side',
  conflictType:
      'public-kinship-recognition-and-family-face-vs-daughters-stated-name-and-boundary',
  ...
  emotionalArc:
      'contained-hope-to-surname-pressure-to-exposure-to-costly-restraint-to-tentative-continuation',
  historicalLearningMechanism:
      'verified-multi-lineage-funding-and-academy-identity-create-causal-surname-pressure-while-family-actions-remain-fiction',
  resolutionType: 'private-continuation-without-public-restoration-claim',
  endingMechanism:
      'daughter-slows-at-threshold-and-the-two-enter-next-courtyard-side-by-side',
  ...
  storyRhythm:
      'agreement-entry-name-pressure-call-raised-phone-step-back-phone-down-cost-threshold-slowing',
);

const suzhouGardenGoldNarrativeDna = JourneyNarrativeDnaRecord(
  journeyId: 'suzhou-humble-administrators-garden',
  narrativeIdentity:
      'grandmother-releases-visual-control-through-repeated-disappearance-and-return',
  protagonistIdentity:
  ...
  locationMechanism:
      'garden-corridors-buildings-bridges-and-water-alternate-occlusion-with-reappearance',
  movementPattern:
  ...
  climaxType:
      'grandmother-completes-unseen-steps-before-grandson-reappears-looking-back',
  consequenceType:
      'grandson-keeps-leading-while-taking-responsibility-to-wait-and-look-back',
  emotionalArc: 'habitual-vigilance-to-alarm-to-contained-fear-to-mutual-trust',
  historicalLearningMechanism:
      'layered-garden-space-makes-short-loss-and-recovery-of-sight-causal-without-turning-Discovery-into-plot',
  resolutionType:
  ...
  storyRhythm:
      'request-first-disappearance-call-return-second-disappearance-restraint-reappearance-reciprocal-waiting',
);
...
const summerPalaceCulturalIntegrationNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  protagonistIdentity:
      'Xu-Cheng-seventeen-year-old-student-photographer-with-grandmother-Zhou-Lan',
  ...
  storyGoal:
      'make-a-flawless-Summer-Palace-photograph-without-grandmother-composition-control',
  locationMechanism:
      'Long-Corridor-lake-route-and-winter-solstice-Seventeen-Arch-Bridge-light-window',
  movementPattern:
      'corridor-pace-conflict-to-northwest-bridge-vantage-and-bend-to-retrieve-photo',
  conflictType: 'flawless-image-vs-restoration-trace-and-grandmother-trust',
  choiceType:
      'lower-camera-during-moving-bridge-light-to-retrieve-grandmothers-old-photograph',
  climaxType:
  ...
  emotionalArc:
      'control-to-irritation-to-time-pressure-to-costly-choice-to-trust-with-residue',
  historicalLearningMechanism:
      '1860-damage-1886-restoration-and-seasonal-bridge-light-enter-through-object-position-and-timing',
  resolutionType:
      'independent-authorship-is-recognized-after-preserving-relational-evidence-at-real-cost',
  endingMechanism:
      'grandmother-entrusts-old-photo-and-old-new-images-share-one-camera-bag-layer',
  memoryAnchorType:
  ...
  supportingStructure:
      'grandmother-with-restoration-history-shifts-from-composition-control-to-entrustment',
  centralMetaphor:
      'a-photograph-cannot-freeze-light-or-history-without-choosing-what-to-preserve',
  narrativeVoice: 'third-person-close-to-Xu-Cheng-action-led',
  storyRhythm:
      'season-arrival-corridor-pace-history-object-vantage-light-photo-fall-choice-loss-reframe-trust',
);

const longmenGoldNarrativeDna = JourneyNarrativeDnaRecord(
  journeyId: 'luoyang-longmen-grottoes',
  narrativeIdentity:
      'equal-coauthors-delete-unsupported-restoration-to-keep-shared-credit-truthful',
  protagonistIdentity:
  ...
  openingSituation:
      'joint-Longmen-film-begins-with-shared-credit-and-shared-evidence-liability',
  storyGoal: 'export-a-jointly-credited-film-both-collaborators-can-defend',
  locationMechanism:
      'Wanfo-inscription-present-damage-old-photograph-and-evidence-based-restoration-set-different-limits',
  movementPattern:
      'editing-timeline-moves-from-unsupported-face-layer-back-to-sourced-photograph-sequence',
  ...
  emotionalArc:
      'defensive-solo-judgment-to-costly-recognition-to-mutual-professional-trust',
  historicalLearningMechanism:
  ...
  endingMechanism:
      'both-names-remain-after-itemized-source-check-and-unused-layer-is-renamed',
  ...
  supportingStructure:
      'equal-collaborator-supplies-source-evidence-and-can-refuse-joint-attribution',
  centralMetaphor:
  ...
  storyRhythm:
      'shared-pledge-niche-evidence-layer-objection-sunk-cost-deletion-source-return-joint-export',
);
...
const datongYungangGoldNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  narrativeIdentity:
      'daughter-cuts-single-colossal-measuring-line-into-three-independent-lines',
  ...
  openingSituation:
      'capital-has-moved-and-father-prepares-to-carry-the-colossal-image-line-south',
  storyGoal:
      'let-three-remaining-workers-own-their-craft-without-preserving-her-exclusive-title',
  locationMechanism:
      'Yungang-transition-from-capital-backed-colossal-caves-to-continuing-smaller-post-494-niches',
  movementPattern:
      'long-line-moves-from-fathers-hand-to-stone-step-to-three-hands-and-three-small-stone-faces',
  conflictType:
      'exclusive-paternal-succession-vs-distributed-responsibility-after-scale-transition',
  ...
  historicalLearningMechanism:
      'verified-capital-move-and-post-move-smaller-carving-change-the-scale-and-social-pressure-encountered-by-fictional-people',
  resolutionType:
      'inheritance-becomes-distributed-responsibility-without-paternal-reconciliation',
  endingMechanism:
  ...
  supportingStructure:
      'father-daughter-succession-conflict-with-brother-and-peer-becoming-independent',
  centralMetaphor:
  ...
  storyRhythm:
      'capital-shift-inheritance-demand-group-risk-cut-title-loss-first-lines-fathers-glance',
);
...
const hongheHaniRiceTerracesNarrativeDna = JourneyNarrativeDnaRecord(
  ...
  temporalPattern:
      'single-contemporary-spring-irrigation-day-from-morning-ditch-round-to-dusk',
  supportingStructure:
