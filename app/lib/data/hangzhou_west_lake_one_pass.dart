...
DiscoveryEntry _discovery(String text, {required String simpleChinese, required String vietnamese, required String english}) => DiscoveryEntry(
  text: text,
...
final hangzhouWestLakeDiscoverySpecs = List<HangzhouDiscoverySpec>.unmodifiable([
  HangzhouDiscoverySpec(level: 1, title: '西湖不是孤立的水面', storyLink: '许澄从苏堤听湖水，也不断听见城市与人的声音。', entry: _discovery('西湖主体是湖面，南、西、北三面由山地环抱，东面与杭州城区相邻；这种“山—湖—城”的关系是文化景观的重要基础。', simpleChinese: '西湖一边连接山水，一边连接杭州城市。', vietnamese: 'Mặt hồ là phần chính của Tây Hồ; núi bao quanh phía nam, tây và bắc, còn phía đông tiếp giáp đô thị Hàng Châu. Quan hệ “núi—hồ—thành phố” này là nền tảng quan trọng của cảnh quan văn hóa.', english: 'The lake surface is West Lake’s central body, enclosed by hills to the south, west, and north and adjoining Hangzhou’s urban area to the east. This mountain–lake–city relationship is a key foundation of the cultural landscape.'), keyTerms: const ['湖面', '三面山地', '城市'], learnerInsight: '西湖从来不是与城市完全隔开的自然容器。', check: '西湖东面主要连接什么？', answer: '杭州城区。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-wgly-west-lake-seasons']),
  HangzhouDiscoverySpec(level: 2, title: '苏堤为什么是“人的痕迹”', storyLink: '许澄把苏堤当成采声路线，后来开始怀疑“人声都在景观之外”这个想法。', entry: _discovery('北宋苏轼在杭州治理西湖时组织疏浚，并利用清出的淤泥等材料修筑长堤；后人称为苏堤。', simpleChinese: '苏堤和西湖治理、疏浚直接相关。', vietnamese: 'Thời Bắc Tống, khi quản lý Tây Hồ ở Hàng Châu, Tô Thức tổ chức nạo vét và dùng bùn cùng vật liệu lấy lên để đắp một con đê dài; người đời sau gọi đó là đê Tô.', english: 'During the Northern Song, Su Shi organized dredging while managing West Lake in Hangzhou and used the removed silt and other material to build a long causeway, later called Su Causeway.'), keyTerms: const ['苏堤', '疏浚', '水利治理'], learnerInsight: '许澄脚下的路线本身就是自然与人工共同形成的结果。', check: '苏堤与哪类历史行动直接相关？', answer: '西湖疏浚和水利治理。', sourceIds: const ['hangzhou-west-lake-su-shi-water-management']),
  HangzhouDiscoverySpec(level: 3, title: '疏浚怎样改变湖的形状', storyLink: '桥边的声音让许澄开始注意“景观结构”而不只注意好不好听。', entry: _discovery('联合国教科文组织资料指出，西湖两条主要堤道和三座人工岛与九至十二世纪之间反复进行的疏浚工程有关。', simpleChinese: '长期疏浚不仅清理湖水，也参与形成堤和岛。', vietnamese: 'Tư liệu UNESCO cho biết hai đê chính và ba đảo nhân tạo của Tây Hồ có liên hệ với những đợt nạo vét lặp lại từ thế kỷ 9 đến thế kỷ 12.', english: 'UNESCO records that West Lake’s two principal causeways and three artificial islands are connected to repeated dredging between the ninth and twelfth centuries.'), keyTerms: const ['疏浚', '堤道', '人工岛'], learnerInsight: '水管理可以同时改变生态条件、交通方式和景观构图。', check: '堤道和人工岛是否完全是天然形成的？', answer: '不是，它们与长期疏浚和人工营造有关。', sourceIds: const ['unesco-hangzhou-west-lake']),
  HangzhouDiscoverySpec(level: 4, title: '什么叫文化景观', storyLink: '许澄在第二次录音中不再把苏堤、桥和人的移动从湖水里分开。', entry: _discovery('西湖文化景观把湖面和三面山地，与堤、岛、桥、亭、塔、园林和植物配置等人工要素组织在同一个整体中。', simpleChinese: '西湖的价值来自自然山水与长期人工营造共同形成的整体。', vietnamese: 'Cảnh quan văn hóa Tây Hồ tổ chức mặt hồ và núi ở ba phía cùng các yếu tố nhân tạo như đê, đảo, cầu, đình, tháp, vườn và bố trí cây cối thành một chỉnh thể.', english: 'The West Lake Cultural Landscape organizes the lake and hills on three sides together with human-made causeways, islands, bridges, pavilions, pagodas, gardens, and planting as one whole.'), keyTerms: const ['文化景观', '自然山水', '人工营造'], learnerInsight: '“自然”和“人造”在这里不是互相排斥的两类。', check: '为什么只录湖水而完全排除人工空间，会漏掉西湖的一部分？', answer: '因为堤、岛、桥、园林等人工要素本来就是文化景观整体的一部分。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-wgly-living-landscape']),
  HangzhouDiscoverySpec(level: 5, title: '文化景观也包含使用', storyLink: '许澄发现堤上的脚步和湖上的船声不是临时贴在风景上的“错误”。', entry: _discovery('西湖的文化景观并非封闭遗址：湖面、堤道、园林与东侧城市今天仍处在参观、通行、游船和日常公共活动之中。', simpleChinese: '西湖今天仍被人使用，不是只供远看的历史画面。', vietnamese: 'Cảnh quan văn hóa Tây Hồ không phải di tích khép kín: mặt hồ, đê, vườn và thành phố phía đông ngày nay vẫn phục vụ tham quan, đi lại, du thuyền và hoạt động công cộng hằng ngày.', english: 'West Lake’s cultural landscape is not a closed monument: its lake, causeways, gardens, and eastern city edge remain places of visiting, passage, boating, and everyday public activity.'), keyTerms: const ['公共活动', '通行', '游船'], learnerInsight: '“活着的文化景观”会持续产生人的声音。', check: '文化景观是否意味着必须把现代公共生活全部清除？', answer: '不是；保护与当代使用可以在同一景观中并存。', sourceIds: const ['hangzhou-wgly-west-lake-seasons', 'hangzhou-gov-west-lake-evolution']),
  HangzhouDiscoverySpec(level: 6, title: '为什么诗画也塑造西湖', storyLink: '许澄最初想录一幅“可以听见的古画”，后来意识到这种想象本身有文化来源。', entry: _discovery('自九世纪以来，西湖持续吸引诗人、学者和艺术家，并对中国以及日本、朝鲜半岛的园林设计产生影响。', simpleChinese: '人们不仅改造西湖，也用诗歌、绘画和园林审美持续解释西湖。', vietnamese: 'Từ thế kỷ 9, Tây Hồ liên tục thu hút thi nhân, học giả và nghệ sĩ, đồng thời ảnh hưởng đến thiết kế vườn ở Trung Quốc, Nhật Bản và bán đảo Triều Tiên.', english: 'Since the ninth century, West Lake has continually attracted poets, scholars, and artists and has influenced garden design in China, Japan, and the Korean Peninsula.'), keyTerms: const ['九世纪', '诗歌', '绘画', '园林'], learnerInsight: '许澄想象的“古典纯净”并不是无文化的自然状态。', check: '西湖长期影响了哪些文化领域？', answer: '诗歌、绘画和园林设计等。', sourceIds: const ['unesco-hangzhou-west-lake']),
  HangzhouDiscoverySpec(level: 7, title: '“西湖十景”是一种观看方法', storyLink: '许澄从筛选声音转向辨认不同声层，像从一个固定画面转向多种观察方式。', entry: _discovery('南宋以来形成的“西湖十景”等题名景观，把特定地点、季节、天气和观看方式组合成文化记忆。', simpleChinese: '“西湖十景”不只是十个地点，也包含人们怎样命名和观看景色。', vietnamese: 'Từ thời Nam Tống, những cảnh quan có tên như “Mười cảnh Tây Hồ” đã kết hợp địa điểm, mùa, thời tiết và cách nhìn cụ thể thành ký ức văn hóa.', english: 'Since the Southern Song, named landscapes such as the Ten Views of West Lake have combined specific places, seasons, weather, and ways of viewing into cultural memory.'), keyTerms: const ['西湖十景', '题名景观', '观看方式'], learnerInsight: '景观经验常由自然条件与文化命名共同形成。', check: '“西湖十景”的意义是否只是列出十个景点？', answer: '不是，它还保存了命名和观看景色的文化方式。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-wgly-west-lake-seasons']),
  HangzhouDiscoverySpec(level: 8, title: '建筑为什么不能脱离湖来读', storyLink: '许澄在桥下听见回声，发现建筑会直接改变声音。', entry: _discovery('西湖的桥、亭、塔、寺庙、园林和植物并非独立展品，而是与湖面、山地、堤岛共同安排视线、路径和空间体验。', simpleChinese: '建筑和园林元素要放回湖、山、堤与路径的整体关系中理解。', vietnamese: 'Cầu, đình, tháp, chùa, vườn và cây cối ở Tây Hồ không phải những vật trưng bày riêng lẻ; cùng với mặt hồ, núi, đê và đảo, chúng tổ chức tầm nhìn, tuyến đi và trải nghiệm không gian.', english: 'West Lake’s bridges, pavilions, pagodas, temples, gardens, and planting are not isolated exhibits; together with the lake, hills, causeways, and islands, they organize sightlines, routes, and spatial experience.'), keyTerms: const ['桥', '亭塔', '园林'], learnerInsight: '桥洞回声是故事里的声学细节，也对应真实空间结构。', check: '为什么故事选择桥边作为转折地点之一？', answer: '因为桥同时改变人的路线、视线和声音传播方式。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-wgly-living-landscape']),
  HangzhouDiscoverySpec(level: 9, title: '为什么西湖以“文化景观”申遗', storyLink: '许澄最后保存的不是无人自然声，而是自然、人工空间与公共生活的叠层。', entry: _discovery('“杭州西湖文化景观”于2011年列入《世界遗产名录》，核心价值强调自然景观与历代人工营造、文化传统长期融合形成的整体。', simpleChinese: '西湖申遗的重点不是“纯自然湖泊”，而是自然与文化共同形成的景观。', vietnamese: 'Cảnh quan văn hóa Tây Hồ Hàng Châu được ghi vào Danh sách Di sản Thế giới năm 2011; giá trị cốt lõi nhấn mạnh chỉnh thể hình thành từ sự hòa quyện lâu dài giữa cảnh quan tự nhiên, công cuộc kiến tạo qua nhiều thời đại và truyền thống văn hóa.', english: 'The West Lake Cultural Landscape of Hangzhou was inscribed on the World Heritage List in 2011; its core value emphasizes the whole formed by the long-term fusion of natural scenery, human shaping across successive eras, and cultural traditions.'), keyTerms: const ['2011年', '世界遗产', '文化景观'], learnerInsight: '许澄对“真实声音”的改变与“文化景观”概念形成同一学习方向。', check: '西湖是以什么类型的遗产概念被理解和保护的？', answer: '文化景观。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-gov-west-lake-inscription']),
  HangzhouDiscoverySpec(level: 10, title: '活着的景观为什么会有杂音', storyLink: '“在场”这条录音把雨、游客、脚步、船和湖水留在同一时间截面。', entry: _discovery('西湖的遗产价值建立在千年以上持续的自然—人工关系上；今天保护这套格局，并不等于把景观冻结成没有人的历史舞台。', simpleChinese: '文化景观既需要保护，也仍与现实城市生活发生关系。', vietnamese: 'Giá trị di sản của Tây Hồ dựa trên quan hệ tự nhiên—nhân tạo được duy trì hơn một nghìn năm; ngày nay bảo vệ bố cục ấy không có nghĩa là đóng băng cảnh quan thành một sân khấu lịch sử không có con người.', english: 'West Lake’s heritage value rests on a natural–human relationship sustained for more than a thousand years; protecting that pattern today does not mean freezing the landscape into an unpeopled historical stage.'), keyTerms: const ['保护', '城市生活', '在场'], learnerInsight: '“真实”不是把所有变化消音，而是知道哪些层次共同构成地点。', check: '为什么许澄最后没有把所有现代声音都删除？', answer: '因为西湖本来就是自然、人类营造与持续城市生活共同形成的文化景观。', sourceIds: const ['unesco-hangzhou-west-lake', 'hangzhou-gov-west-lake-evolution']),
]);
