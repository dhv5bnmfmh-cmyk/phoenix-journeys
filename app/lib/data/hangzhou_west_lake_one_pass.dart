...
final hangzhouWestLakeOnePassLevels = List<JourneyLevelContent>.unmodifiable([
  ...
  _hangzhouLevel([
    ...
    '她第二次走到桥边时，脚步在石面和桥洞下形成不同的回声，一艘游船经过，桨声与水波一起靠近。她再次准备删掉，却看见堤上不断有人来去。苏堤本身就来自长期的湖水治理和人工营造，西湖的堤、岛、桥、园林与山水共同组成文化景观；把所有人的声音清掉，反而像把其中一层历史关系擦掉。她没有删除，而在记录表上写下“桥上人流”。不久乌云压低，第一滴雨打进麦克风，湖面迅速密起来，人们开伞、收东西、加快脚步。许澄把麦克风转向堤上，再缓缓转回水面，让雨、人声、脚步和湖水在同一段录音里改变。第二天，她把文件存成日期、苏堤路线和“在场”。'
  ]),
  _hangzhouLevel([
