...
final forbiddenCityStoryParagraphsByLevel = <List<String>>[
  ...
  <String>[
    '第二天，新学徒照着沈砚留下的图出发。他从午门沿中轴向北走。他却把午前要送回东侧的记录带到乾清门前。阿宁赶来，没有责怪他。她只问：“图上为什么没有写任务？”她的任务是把记录送回东边，所以走了另一条路线。沈砚原以为保留两条线已经够了。这时他才发现，没有用途和时限，常用线仍会被当成指令。阿宁说：“先看记录要去哪里，再决定走哪条线。”两人重新看图。他们核对交接签记、两个终点和午前时限。两条路线都能到乾清门前，但服务不同任务。沈砚在阿宁的线旁写“午前送回东边”。他也在自己的线上标出“观察宫门”。新学徒按新标记及时完成交接。沈砚把笔递给阿宁，请她检查任务说明。两人不再互相证明路线，而是共同为后来的人负责。周师傅没有选一条，只让他们说清为什么这样走。',
  ],
  <String>[
