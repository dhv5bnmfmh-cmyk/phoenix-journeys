...
const forbiddenCityParagraphRebuild = <ForbiddenCityParagraphRebuild>[
  ...
  ForbiddenCityParagraphRebuild(level: 7, segments: ['这一次，他没有跨过去。', '门确实开着。', '沈砚再次看向门槛。', '但“打开”是否等于“允许”，第一次变成了必须由他自己回答的问题。'], correctOrder: [1, 3, 2, 0]),
...
const forbiddenCityMissingSentence = <ForbiddenCityMissingSentence>[
  ...
  ForbiddenCityMissingSentence(level: 7, before: '门确实开着。', answer: '但“打开”是否等于“允许”，第一次变成了必须由他自己回答的问题。', after: '沈砚盯着门后的院落。'),
