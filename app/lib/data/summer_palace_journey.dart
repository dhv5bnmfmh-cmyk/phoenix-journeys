...
const summerPalaceStoryParagraphs = <String>[
  ...
  '两人没有赶上计划中的落日位置，只看见昆明湖把桥、亭台和灰蓝天空收入倒影。孟秋原本为失约而难受，母亲却把刚拍的照片递给她：十七孔桥没有截断水面，桥、岛与远山在不同步伐里重新相接。孟秋讲起皇家园林经历设计、损失与修复，今天所见并非从未改变的古园；母亲则指出，每换一个角度，佛香阁都像移动一次，长廊的开口也会把同一片湖分成不同画面。孟秋忽然明白，记录不能只写纹样长什么样，还要留下人从哪里看见它。她在工作表里补上行走方向、光线和对应廊柱，让彩画与借景、对景的关系融合起来。离开前，她们没有追回原来的计划，而是并肩回望湖光山色。被打乱的约定没有消失：孟秋以准确记录承担工作的后果，母亲也用一路走来的照片参与了她的选择，工作与亲情因此找到新的观看位置。',
];
...
const summerPalaceStoryAnnotations = <ReadingAnnotation>[
  ...
  ReadingAnnotation(
    pinyin:
        'liǎng rén méi yǒu gǎn shàng jì huà zhōng de luò rì wèi zhì ， zhǐ kàn jiàn kūn míng hú bǎ qiáo 、 tíng tái hé huī lán tiān kōng shōu rù dǎo yǐng 。 mèng qiū yuán běn wèi shī yuē ér nán shòu ， mǔ qīn què bǎ gāng pāi de zhào piàn dì gěi tā ： shí qī kǒng qiáo méi yǒu jié duàn shuǐ miàn ， qiáo 、 dǎo yǔ yuǎn shān zài bù tóng bù fá lǐ chóng xīn xiāng jiē 。 mèng qiū jiǎng qǐ huáng jiā yuán lín jīng lì shè jì 、 sǔn shī yǔ xiū fù ， jīn tiān suǒ jiàn bìng fēi cóng wèi gǎi biàn de gǔ yuán ； mǔ qīn zé zhǐ chū ， měi huàn yí gè jiǎo dù ， fó xiāng gé dōu xiàng yí dòng yí cì ， cháng láng de kāi kǒu yě huì bǎ tóng yí piàn hú fēn chéng bù tóng huà miàn 。 mèng qiū hū rán míng bai ， jì lù bù néng zhǐ xiě wén yàng zhǎng shén me yàng ， hái yào liú xià rén cóng nǎ lǐ kàn jiàn tā 。 tā zài gōng zuò biǎo lǐ bǔ shàng xíng zǒu fāng xiàng 、 guāng xiàn hé duì yìng láng zhù ， ràng cǎi huà yǔ jiè jǐng 、 duì jǐng de guān xi róng hé qǐ lái 。 lí kāi qián ， tā men méi yǒu zhuī huí yuán lái de jì huà ， ér shì bìng jiān huí wàng hú guāng shān sè 。 bèi dǎ luàn de yuē dìng méi yǒu xiāo shī ： mèng qiū yǐ zhǔn què jì lù chéng dān gōng zuò de hòu guǒ ， mǔ qīn yě yòng yí lù zǒu lái de zhào piàn cān yù le tā de xuǎn zé ， gōng zuò yǔ qīn qíng yīn cǐ zhǎo dào xīn de guān kàn wèi zhì 。',
    vietnamese:
        'Họ lỡ chỗ ngắm hoàng hôn nhưng thấy hồ phản chiếu cầu, đình và trời xanh xám. Mẹ đưa những ảnh vừa chụp và chỉ ra rằng cầu, đảo, núi xa cùng Phật Hương Các đổi quan hệ theo mỗi bước chân. Mạnh Thu hiểu hồ sơ không chỉ cần hình dạng họa tiết mà còn phải ghi nơi người quan sát đứng. Cô bổ sung hướng đi, ánh sáng và số cột để nối tranh màu với mượn cảnh và đối cảnh. Họ không lấy lại kế hoạch cũ; Mạnh Thu nhận hậu quả của lựa chọn làm việc chính xác, còn ảnh của mẹ giúp công việc và tình thân tìm được góc nhìn mới.',
    english:
        'They miss their planned sunset spot but see the lake reflect bridges, pavilions, and a grey-blue sky. Her mother shares photographs showing how the bridge, island, distant hills, and Tower of Buddhist Incense change with each step. Meng Qiu realizes a record must preserve not only a motif but also the viewer\'s position. She adds walking direction, light, and column numbers, connecting painted decoration with borrowed and paired views. They do not recover the old plan: Meng Qiu accepts the consequence of accurate work, while her mother\'s photographs give work and family a new viewpoint.',
  ),
];
