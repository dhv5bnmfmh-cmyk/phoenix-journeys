...
const templeWords = <WordEntry>[
  ...
  WordEntry(
    word: '压缩',
    pinyin: 'yāsuō',
    simpleChinese: '把较多内容缩短或集中。',
    translation: 'Nén, rút gọn.',
    englishDefinition: 'to compress or condense',
    symbol: '🗜️',
    examples: <WordExample>[
      WordExample(
        chinese: '短片可以压缩时间，但不能把不同礼仪剪成同一场。',
        pinyin: 'Duǎnpiàn kěyǐ yāsuō shíjiān, dàn bù néng bǎ bùtóng lǐyí jiǎn chéng tóng yì chǎng.',
        vietnamese: 'Phim ngắn có thể nén thời gian, nhưng không thể dựng các nghi lễ khác nhau thành cùng một nghi lễ.',
        english: 'A short film may compress time, but it must not edit distinct rites into one event.',
      ),
    ],
  ),
  ...
  WordEntry(
    word: '试看片',
    pinyin: 'shìkànpiàn',
    simpleChinese: '正式发布前给少量观众看的测试版本。',
    translation: 'Bản phim xem thử.',
    englishDefinition: 'test screening cut',
    symbol: '👀',
    examples: <WordExample>[
      WordExample(
        chinese: '试看片让林桥发现观众真的把两个礼仪看成了一场。',
        pinyin: 'Shìkànpiàn ràng Lín Qiáo fāxiàn guānzhòng zhēnde bǎ liǎng gè lǐyí kàn chéng le yì chǎng.',
        vietnamese: 'Bản phim xem thử khiến Lâm Kiều nhận ra khán giả thật sự hiểu hai nghi lễ thành một.',
        english: 'The test screening showed Lin Qiao that viewers really understood the two rites as one event.',
      ),
    ],
  ),
  ...
  WordEntry(
    word: '线索',
    pinyin: 'xiànsuǒ',
    simpleChinese: '帮助判断事情关系的信息。',
    translation: 'Manh mối.',
    englishDefinition: 'clue or evidence cue',
    symbol: '🧩',
    examples: <WordExample>[
      WordExample(
        chinese: '连续的脚步声和“然后”都是制造误解的线索。',
        pinyin: 'Liánxù de jiǎobùshēng hé “ránhòu” dōu shì zhìzào wùjiě de xiànsuǒ.',
        vietnamese: 'Tiếng bước chân liên tục và từ “sau đó” đều là manh mối tạo ra sự hiểu lầm.',
        english: 'The continuous footsteps and the word “then” are both clues that create the misunderstanding.',
      ),
    ],
  ),
  ...
  WordEntry(
    word: '尺度',
    pinyin: 'chǐdù',
    simpleChinese: '这里指一个来源能够支持多大范围的说法。',
    translation: 'Phạm vi, mức độ.',
    englishDefinition: 'scope or extent of a claim',
    symbol: '📏',
    examples: <WordExample>[
      WordExample(
        chinese: '不同来源能支持的结论尺度并不相同。',
        pinyin: 'Bùtóng láiyuán néng zhīchí de jiélùn chǐdù bìng bù xiāngtóng.',
        vietnamese: 'Các nguồn khác nhau không hỗ trợ kết luận ở cùng một phạm vi.',
        english: 'Different sources do not support claims at the same scope.',
      ),
    ],
  ),
  WordEntry(
    word: '断言',
    pinyin: 'duànyán',
    simpleChinese: '很明确地说某件事一定如此。',
    translation: 'Khẳng định chắc chắn.',
    englishDefinition: 'assertion',
    symbol: '📌',
    examples: <WordExample>[
      WordExample(
        chinese: '证据不足时，不应该把概述写成更具体的断言。',
        pinyin: 'Zhèngjù bùzú shí, bù yīnggāi bǎ gàishù xiě chéng gèng jùtǐ de duànyán.',
        vietnamese: 'Khi chứng cứ chưa đủ, không nên biến phần khái quát thành một khẳng định cụ thể hơn.',
        english: 'When evidence is insufficient, an overview should not be turned into a more specific assertion.',
      ),
    ],
  ),
