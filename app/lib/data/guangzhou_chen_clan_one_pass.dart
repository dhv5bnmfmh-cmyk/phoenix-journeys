...
JourneyLevelContent _guangzhouLevel(List<String> paragraphs) {
      ...
      for (var i = 0; i < paragraphs.length; i++)
        ReadingAnnotation(
          ...
          vietnamese: single
              ...
              : i == 0
                  ? 'Lương Dao, 22 tuổi, cùng bạn học gốm Hạ Chân quan sát trang trí tại Trần Gia Từ và chỉ thử nghiệm trên vật liệu của mình. Mẫu giấy đầu tiên bị đứt vì cô sao chép từng đường thấy được; giới hạn của giấy biến việc sao chép bề mặt thành một vấn đề cấu trúc.'
          ...
          english: single
              ? 'Twenty-two-year-old printmaking student Liang Yao and her ceramics-student peer He Zhen observe decoration at the Chen Clan Academy. Working only on their own paper, Liang Yao sees her first literal-contour prototype break into disconnected pieces. She changes the encoding and leaves paper bridges. The second prototype lifts as one connected piece, and He Zhen can still identify the important visual relation. Back in the studio, Liang Yao applies the changed method to a new material study.'
              : i == 0
...
final guangzhouChenClanOnePassLevels =
  ...
  _guangzhouLevel([
    ...
    '梁遥没有向贺真解释一套理论，也没有把失败碎片重新分类。她直接换第二张纸，在主要形体的关系不变的前提下改变连接方法：停止逐线切割，在容易断开的节点保留纸桥。纸桥是纸的结构需要，不是假装原装饰多出了一条线。第二件剪完后，梁遥从一角把作品提离桌面；整张纸仍连着，没有任何片段掉下。贺真没有看底稿，却指出两组主要形体原先怎样相接。作品因为编码改变而获得可拿取的整体，也没有丢掉关键关系。梁遥从表面复制者开始变成材料翻译者。回到工作室，她拿起新的版材，在画轮廓前先标出“这种材料靠什么连接”，随后开始下一次材料研究。',
  ]),
  _guangzhouLevel([
    ...
    '梁遥没有接受“断开也算作品”，更没有因为时间压力拒绝一个可行机会。她要的是成功的纸对象，只是成功条件必须改写。她在第二张纸上重画连接：保留形体的相对位置和主要方向，在原本会被彻底切开的地方留下纸桥，让结构先满足纸的连续性。剪完以后，她捏住一个角把原型提起，整张纸悬在手里仍是一件完整对象。贺真作为同伴而不是导师，没有替她下结论；他只是看着成品，准确指出两组主要形体之间的关系仍然可读。梁遥由此把“复制轮廓”改成“翻译关系”。回到工作室，她拿出一种新的版材，先测试它自己的连接和承力方式，再开始下一件材料练习。',
  ]),
  _guangzhouLevel([
    ...
    '梁遥不再把忠实等同于逐线复制。她把第二张纸当成一种需要被翻译的媒介：主要形体的相对关系保留，但连接方式重新编码，在会断开的关键位置留下纸桥。那些纸桥不是她声称在历史装饰上发现的新细节，而是新材料为了完整工作而必须拥有的结构。她剪完后从一个角提起第二件原型，整张纸没有散开；贺真看了几秒，仍能识别原先最重要的相接关系。成功来自改变编码，而不是牺牲结果。梁遥把第一件断开的碎片放进材料袋，在笔记上写下“先问材料怎样连接”。回到工作室，她拿起一块新版材，先观察它的硬度和连接条件，再开始下一次材料研究。',
  ]),
  _guangzhouLevel([
    '二十二岁的版画学生梁遥和陶艺同学贺真在广州陈家祠进行跨材料练习。陈家祠集中展示多种岭南装饰工艺，同一建筑中的材料差异让“形式怎样依靠材料成立”变成一个现场可见的问题。两人只观察，不把纸、工具或颜料放到历史装饰表面；全部试切发生在自己的材料上。梁遥的目标是一件单张纸解释：作品离开桌面后仍须完整，贺真也必须能识别她从建筑装饰中观察到的主要形体关系。第一件原型却在剪完时散开。梁遥把每条可见轮廓都当成切割边界，追求字面复制；当最后一段纸被切掉，几个部分立刻断开。她意识到，问题不是需要补一条历史证据，更不是重新分类看到的对象，而是纸的材料限制要求另一种结构编码。',
    '梁遥没有把失败当成值得保留的不完整结果，也没有拒绝继续制作。她换第二张自己的纸，重新编码连接：主要形体的位置、方向和相互靠近方式继续保留，但原本会完全分离的节点留下窄纸桥。纸桥没有冒充历史装饰的真实线条，只负责让纸的结构连续。她剪完第二件原型，从一角提起；整张纸仍完整连在一起。贺真没有看草图，也没有以导师身份给她答案，却准确识别两组主要形体之间的相接关系。改变编码让新的纸对象既能工作又保持可读。梁遥从表面复制者转成材料翻译者，把“逐线照搬”改写成“关系在新媒介里怎样成立”。回到工作室，她拿起一块不同的版材，先标出这种材料必须保留的连接，再开始新的材料研究。',
  ]),
  _guangzhouLevel([
    '二十二岁的版画学生梁遥和陶艺同学贺真在广州陈家祠观察建筑装饰。陈家祠集中展示多种岭南装饰工艺，正因为材料并不相同，梁遥把“材料怎样让形体相接”当成观察重点。两人只观察，不把纸贴到、压到、描在或摩擦任何历史表面；所有试切都在自己的材料上完成。梁遥想把自己观察到的一组主要形体关系做成一张单张纸的解释，让它既能拿在手里保持为一个整体，又让贺真仍能认出那组关系。她的第一件原型却在桌面上散开：她把每一道看见的轮廓都当成必须照搬的边界，剪到两组形体之间时，纸上原本承担连接的部分也被一起去掉，几个部分随即断开。问题不是她少看了证据，也不是要判断哪一种历史解释更真实；是纸这种材料不能替孤立形体保持原先的连接。字面复制越彻底，单张纸反而越无法成为一件东西。',
    '梁遥没有放弃完整结果，也没有接受一个故意残缺的版本。她停下逐线描摹，在第二张自己的纸上重新编码连接：保留主要形体的相对位置，却在原本会断开的地方留下窄窄的纸桥。纸桥不是她假装在陈家祠装饰上看见的新线，而是纸这种媒介为了保持结构而需要的连接。她剪完第二件原型，从一角把它提起；整张纸没有散开。贺真没有看她的草图，仍指出两组主要形体之间原先最重要的相接关系。新的纸片不是“少复制一点”的妥协，而是因为编码改变，所以同时获得连接性和可识别性。梁遥把第一件散开的碎片收进材料袋，没有给它改分类；她在笔记本上把“照着表面复制”划掉，写下“先问材料怎样连接”。回到工作室，她拿起一块新的版材，先标出这种材料必须保留的连接，再开始下一次材料研究。',
  ]),
]);
...
final guangzhouChenClanWordTraces = List<RemediatedWordTrace>.unmodifiable([
  ...
  const RemediatedWordTrace(word: '材料', eventId: 'GZ-E3-medium-conflict', usage: 'Lv2 首次出现。', sourceText: '纸没有原来材料的支撑，照着表面复制反而让作品失去连接。'),
...
const guangzhouChenClanCompletion = RemediatedCompletion(
  ...
  journeyCompletion: '《纸桥》完成：梁遥不再把忠实等同于表面复制，而把新的连接方法带进下一次材料研究。陈家祠仍有更多工艺可以观察。',
);
