...
const kaipingStoryArchitectures = <Map<String, String>>[
  {
    ...
    'CONSEQUENCE': '合建继续；远方形式没有被整套复制',
    'TRANSFORMATION': '从“带回来就该照着做”转向“交流意味着选择与重组”',
    'ENDING': '原图留在箱底，记忆句是“回来，不等于照搬”',
...
final kaipingDiaolouGoldJourney = RemediatedJourney(
  ...
  challenges: const <RemediatedChallengeTrace>[
    RemediatedChallengeTrace(
      ...
      anchor: '海外图样→众楼共同使用→改图→“回来，不等于照搬”',
    ),
    RemediatedChallengeTrace(
      type: 'grammarRepair',
  ...
  memory: const <RemediatedMemoryReview>[
    ...
    RemediatedMemoryReview(
      category: 'memory',
      prompt: '梁川最后记住的那句话是什么？',
      answer: '“回来，不等于照搬。”',
      storyEventIds: ['KP-E4'],
    ),
  ],
  completion: const RemediatedCompletion(
    journeySummary: '梁川没有把远方经验当成不可修改的模板，而让它在众楼的共同使用关系中重新组合。',
    achievement: '侨乡重组者',
    memoryAnchor: '箱底那张没有被原样照搬的图',
