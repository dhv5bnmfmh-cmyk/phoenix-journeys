...
const _qufuP = <String>[
  ...
  '正式仪式那天，古柏下的孔言只在碑刻前说：“礼也要看见人。”领诵走到侧廊时，队伍停下来等轮椅转过碑亭；孔言退到队尾，把中轴上的主位留空。',
];
const _qufuA = <ReadingAnnotation>[
  ...
  ReadingAnnotation(pinyin:'zhèng shì yí shì nà tiān ， gǔ bǎi xià de kǒng yán zhǐ zài bēi kè qián shuō ：“ lǐ yě yào kàn jiàn rén 。” lǐng sòng zǒu dào cè láng shí ， duì wu tíng xià lái děng lún yǐ zhuǎn guò bēi tíng ； kǒng yán tuì dào duì wěi ， bǎ zhōng zhóu shàng de zhǔ wèi liú kōng 。',vietnamese:'Ngày chính lễ, dưới cây bách cổ, Khổng Ngôn chỉ nói trước văn bia: “Lễ cũng phải nhìn thấy con người.” Khi phần lĩnh xướng tới hành lang bên, cả đoàn dừng lại chờ xe lăn qua đình bia; Khổng Ngôn lùi xuống cuối và để trống vị trí chính trên trục giữa.',english:'On the ceremony day beneath ancient cypresses, Kong Yan says only, “Ritual must also see people.” When the recitation reaches the side corridor, the procession waits for the wheelchair to clear the stele pavilion; Kong Yan steps to the rear and leaves the central position empty.'),
];
...
const _leshanP = <String>[
  ...
  '返航后，父亲只问：“都平安吗？”何川摊开航线图，圈出三江急流逼他转向的位置，又在旁边记下崖壁风化和排水沟。父亲没有夸他，只把下一次夜航的日期写在图角。',
];
const _leshanA = <ReadingAnnotation>[
  ...
  ReadingAnnotation(pinyin:'fǎn háng hòu ， fù qīn zhǐ wèn ：“ dōu píng ān ma ？” hé chuān tān kāi háng xiàn tú ， quān chū sān jiāng jí liú bī tā zhuǎn xiàng de wèi zhì ， yòu zài páng biān jì xià yá bì fēng huà hé pái shuǐ gōu 。 fù qīn méi yǒu kuā tā ， zhǐ bǎ xià yí cì yè háng de rì qī xiě zài tú jiǎo 。',vietnamese:'Về bến, cha chỉ hỏi: “Mọi người đều an toàn chứ?” Hà Xuyên trải bản đồ, khoanh chỗ dòng xiết của ba sông buộc cậu đổi hướng rồi ghi thêm phong hóa vách đá và rãnh thoát nước. Cha không khen, chỉ viết ngày chuyến đêm tiếp theo vào góc bản đồ.',english:'Back ashore, his father asks only, “Is everyone safe?” He Chuan spreads out the route map, circles where the three rivers forced his turn, and notes the weathered cliff and drainage channels. His father offers no praise; he writes the date of the next night voyage in the corner.'),
];
