...
final dailyJourneyExperiences = <DailyJourneyExperience>[
  DailyJourneyExperience(
    ...
    description: '跟随沈砚与阿宁对照两条不同路线，在共同节点看见宫殿空间怎样因身份与目的而改变。',
  ...
  DailyJourneyExperience(
    ...
    description: '母亲在外滩把外祖父的旧提单交给林岸；过江以后，他不再把上海分成互不相干的过去与未来。',
  ...
  DailyJourneyExperience(
    ...
    description: '搬家前，周遥想用最后一圈告别城内生活；跑表越过永宁门后，他把老家与新家留在同一条路线上。',
