...
const Map<String, String> _journeyStartupDescriptions = <String, String>{
  ...
  'beijing-temple-of-heaven': '校展截止前，林桥与何予发现一个漂亮转场把祈年殿祈谷和圜丘冬至祭天剪成了同一场礼仪。',
  ...
  'suzhou-humble-administrators-garden':
      '外婆第一次让十二岁的外孙走在前面，在拙政园一次次消失又重现的视线里学着不再把他喊回来。',
...
const List<JourneyStartupMetadata> journeyStartupMetadata =
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'PYG',
    place: '平遥古城',
    distanceLabel: '1,660 km',
    geoNodeId: 'cn-shanxi-jinzhong-pingyao-ancient-city',
    stampSymbol: '票',
    headline: '一张汇票让谁留下',
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'JNG',
    place: '孔庙',
    distanceLabel: '1,690 km',
    geoNodeId: 'cn-shandong-jining-qufu-confucius-temple',
    stampSymbol: '礼',
    headline: '沿中轴读懂礼与学',
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'LSS',
    place: '乐山大佛',
    distanceLabel: '1,210 km',
    geoNodeId: 'cn-sichuan-leshan-shizhong-giant-buddha',
    stampSymbol: '佛',
    headline: '三江与石刻的千年守望',
  ...
  JourneyStartupMetadata(
    ...
    geoNodeId: 'cn-fujian-nanping-wuyishan-nine-bend-stream',
    stampSymbol: '曲',
    headline: '山水之间的理学回声',
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'HHE',
    place: '哈尼梯田',
    distanceLabel: '680 km',
    geoNodeId: 'cn-yunnan-honghe-yuanyang-hani-terraces',
    stampSymbol: '田',
    headline: '她把水分回原来的宽度，也失去了今天借来的牛',
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'HSG',
    place: '黄山风景区',
    distanceLabel: '1,120 km',
    geoNodeId: 'cn-anhui-huangshan-scenic-area',
    stampSymbol: '云',
    headline: '在岩缝与云层之间',
  ...
  JourneyStartupMetadata(
    ...
    geoNodeId: 'cn-hunan-zhangjiajie-wulingyuan-scenic-area',
    stampSymbol: '峰',
    headline: '穿过三千峰柱',
  ...
  JourneyStartupMetadata(
    ...
    place: '宋都古城',
    distanceLabel: '1,620 km',
    geoNodeId: 'cn-henan-kaifeng-song-capital',
    stampSymbol: '宋',
    headline: '在叠城中寻找东京',
  ...
  JourneyStartupMetadata(
    ...
    geoNodeId: 'cn-yunnan-dali-ancient-city',
    stampSymbol: '洱',
    headline: '山城湖的共同呼吸',
  ...
  JourneyStartupMetadata(
    ...
    cityCode: 'HRB',
    place: '中央大街',
    distanceLabel: '2,760 km',
    geoNodeId: 'cn-heilongjiang-harbin-daoli-central-street',
    stampSymbol: '冰',
    headline: '冰雪里的建筑记忆',
...
JourneyStartupMetadata requireJourneyStartupMetadata(String journeyId) {
  ...
  if (metadata == null) {
    throw StateError(
        'Journey startup metadata is not registered: "$journeyId".');
  }
  return metadata;
}
...
/// Normal discovery surface. Hidden content remains in
/// [journeyStartupMetadata] and is still directly resolvable by ID.
final List<JourneyStartupCityMetadata> publishedJourneyStartupCityCatalog =
    List<JourneyStartupCityMetadata>.unmodifiable(<JourneyStartupCityMetadata>[
  JourneyStartupCityMetadata(
    id: 'beijing',
    name: '北京',
    cityCode: 'PEK',
    destinations:
        List<JourneyStartupMetadata>.unmodifiable(<JourneyStartupMetadata>[
      requireJourneyStartupMetadata('beijing-forbidden-city'),
      requireJourneyStartupMetadata('beijing-temple-of-heaven'),
    ]),
  ),
]);

JourneyStartupCityMetadata requirePublishedJourneyStartupCity(String cityId) {
  for (final city in publishedJourneyStartupCityCatalog) {
