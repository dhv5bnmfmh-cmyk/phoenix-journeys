...
class _ForbiddenCityReferenceChallengePanelState
  ...
  @override
  void didUpdateWidget(covariant ForbiddenCityReferenceChallengePanel oldWidget) {
  ...
  int _resolveLevel() {
    final active = widget.storyParagraphs.map((item) => item.trim()).join('\n\n');
    ...
    return Column(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          onPressed: _resolved ? _continue : (_canSubmit ? () => _submit(choices) : null),
          style: FilledButton.styleFrom(
            backgroundColor: PhoenixTheme.red,
            foregroundColor: Colors.white,
          ),
          icon: Icon(_resolved ? Icons.arrow_forward_rounded : Icons.check_rounded),
          label: Text(
            t(
              _resolved
  ...
  Widget _choiceTile(_ReferenceChoice choice, int index) {
    ...
    return OutlinedButton(
      ...
      onPressed: _resolved ? null : () => setState(() => _selectedChoice = index),
      style: OutlinedButton.styleFrom(
