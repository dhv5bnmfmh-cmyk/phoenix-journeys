...
import 'screens/phoenix_world_experience.dart';
...
class PhoenixApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final experience = uri.queryParameters['experience'];
    ...
    final showWorldExperience =
        experience == 'all' || prototype == 'world-journeys';

    return MaterialApp(
      title: 'Phoenix Journeys',
      debugShowCheckedModeBanner: false,
      theme: PhoenixTheme.light,
      home: showWorldExperience
          ? const PhoenixWorldExperience()
          : showCoinJourney
