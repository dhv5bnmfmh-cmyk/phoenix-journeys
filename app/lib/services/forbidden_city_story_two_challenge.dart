...
const _levels = <_LevelSpec>[
  ...
  _LevelSpec(
    rebuilds: <_RebuildSpec>[
      ...
      _RebuildSpec('复原杜衡给出的两种选择。', '让相机适应现场或者选择让现场服从相机', <String>['让相机适应现场', '或者选择', '让现场服从相机'], '你可以让相机适应现场，也可以让现场服从相机。', '理解两类策略的对照', '用选择结构组织策略'),
    ],
    grammars: <_GrammarSpec>[
  ...
  _LevelSpec(
    rebuilds: <_RebuildSpec>[
      _RebuildSpec('复原白昀最后写下的记录。', '亮到这里就已经足够了', <String>['亮到这里', '就已经', '足够了'], '她把拍摄记录最后一栏写成：“亮到这里，就够了。”', '识别故事最终决策语言', '用“就够了”表达主动停止'),
