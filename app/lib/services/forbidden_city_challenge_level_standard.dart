...
const _levels = <List<_Spec>>[
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '两人对照宫门、院落、方向和共同终点后，发现两条路线____。', answer: '都能走通只是目标不同', options: <String>['都能走通只是目标不同','只有中轴路线正确','都必须从午门开始','与人物任务无关'], sourceSentence: '两人对照空间后发现两条路线都能走通，只是目标不同。', learning: '用多项观察补全结论', knowledge: '路线可行性', language: '转折复句', reasoning: '整合位置与目标', why: 'Story 的核对结果是两条线都可行、目标不同。', difficulty: 'Lv3 关系补全', storyEvidence: '发现两条路线都能走通，只是目标不同。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '沈砚重新画图时，不再用一条线覆盖另一条，而是标出____。', answer: '两人的任务与共同到达点', options: <String>['两人的任务与共同到达点','一个唯一答案','谁先进入紫禁城','所有院落的名称'], sourceSentence: '沈砚重新画图时标出两人的任务与共同到达点。', learning: '把空间与人物信息同时纳入图', knowledge: '任务与共同节点', language: '而是结构', reasoning: '选择能解释两条路线的信息', why: 'Story 直接写出任务与共同到达点被标注。', difficulty: 'Lv4 关系补全', storyEvidence: '标出两人的任务与共同到达点。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '阿宁要求逐点核对：哪里由院落相连，哪里通过宫门转向，哪里两条线在____会合。', answer: '乾清门前', options: <String>['乾清门前','午门外','北京城外','内廷最北端'], sourceSentence: '阿宁逐点核对空间关系，并确认两条线在乾清门前会合。', learning: '完成多项空间核对链', knowledge: '乾清门共同节点', language: '哪里…哪里…', reasoning: '从并列空间线索定位共同点', why: 'Story 明确写两条线在乾清门前会合。', difficulty: 'Lv5 空间序列', storyEvidence: '哪里两条线在乾清门前会合。', knowledgeSource: '故宫博物院·乾清门'),
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '沈砚把两条路线都保留，是因为他发现它们____。', answer: '分别解释空间关系和任务需要', options: <String>['分别解释空间关系和任务需要','实际上完全相同','都必须沿中轴','都不需要建筑证据'], sourceSentence: '沈砚保留两条路线，因为它们分别解释空间关系和任务需要。', learning: '根据证据补全保留理由', knowledge: '路线功能差异', language: '因为结构', reasoning: '综合两条路线功能', why: '两条路线服务不同的信息与任务功能。', difficulty: 'Lv5 原因综合', storyEvidence: '自己的线适合说明中轴关系，阿宁的线更直接地服务她的任务。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '阿宁把争论拆成两个问题后，沈砚承认自己的图只表达了____。', answer: '一个观察顺序', options: <String>['一个观察顺序','所有人的唯一任务','完整的东侧路线','内廷全部功能'], sourceSentence: '沈砚承认自己的图只表达了一个观察顺序。', learning: '理解人物重新定义自己的图', knowledge: '中轴观察顺序', language: '只表达', reasoning: '由分析结果修正原判断', why: 'Story 直接写沈砚承认图只表达一个观察顺序。', difficulty: 'Lv6 认知修正', storyEvidence: '沈砚承认自己的图只表达了一个观察顺序。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '阿宁要求沈砚区分“建筑允许怎样连接”和“____”。', answer: '任务要求我去哪里', options: <String>['任务要求我去哪里','谁先拿到图笔','哪条线画得更粗','午门是否存在'], sourceSentence: '阿宁要求沈砚区分建筑允许怎样连接和任务要求我去哪里。', learning: '补全两类判断', knowledge: '建筑约束、任务目标', language: '并列引用', reasoning: '空间条件转向行动目标', why: '原文正是把这两类问题并列区分。', difficulty: 'Lv7 概念补全', storyEvidence: '区分“建筑允许怎样连接”和“任务要求我去哪里”。', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '沈砚撤回“只有一条正确路线”的判断，是因为____。', answer: '两条路线都能在真实建筑约束下成立', options: <String>['两条路线都能在真实建筑约束下成立','阿宁要求他无条件认错','周师傅规定必须画两条线','中轴不再存在'], sourceSentence: '沈砚撤回排他判断，是因为两条路线都有真实空间证据。', learning: '从证据链补全认知变化', knowledge: '共同约束、多路线', language: '因为结构', reasoning: '整合两条空间证据', why: '中轴支持一条路线，东侧连接独立支持另一条。', difficulty: 'Lv7 多证据补全', storyEvidence: '中轴确实构成沈砚路线的重要骨架；东侧空间与乾清门前的连接也使阿宁的路线成立。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '“哪些建筑条件是两人都不能忽略的”是在寻找____。', answer: '共同约束', options: <String>['共同约束','个人偏好','谁先到达','路线名称'], sourceSentence: '这个问题是在寻找两条路线共享的共同约束。', learning: '从问题抽象概念', knowledge: '建筑共同条件', language: '是在寻找', reasoning: '由具体提问抽象推理类别', why: '两人都不能忽略的建筑条件就是共同约束。', difficulty: 'Lv8 概念抽象', storyEvidence: '哪些建筑条件是两人都不能忽略的？', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '沈砚让阿宁决定怎样呈现自己的路线，说明他放弃了____。', answer: '用自己的框架替她做全部解释', options: <String>['用自己的框架替她做全部解释','理解中轴的价值','记录共同节点','检查空间连接'], sourceSentence: '沈砚让阿宁决定怎样呈现自己的路线，放弃替她做全部解释。', learning: '从行动推断解释权变化', knowledge: '视角与解释权', language: '说明结构', reasoning: '由呈现权推断态度', why: 'Story 明确把路线呈现权交回阿宁。', difficulty: 'Lv8 人物推断', storyEvidence: '他让阿宁决定怎样呈现自己的路线，自己只补充两条线之间的连接说明。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '最终路线结论不仅要回答“能不能走”，还要回答“____”。', answer: '为什么这个任务应这样走', options: <String>['为什么这个任务应这样走','谁最早画了路线','哪条线颜色更深','谁记住更多建筑名'], sourceSentence: '最终路线结论不仅要回答能不能走，还要回答为什么这个任务应这样走。', learning: '整合可行性与理由', knowledge: '空间、任务', language: '不仅…还…', reasoning: '从存在判断升级为理由判断', why: '好的判断必须写明成立理由。', difficulty: 'Lv10 综合补全', storyEvidence: '好的判断要说明自己凭什么成立。', knowledgeSource: '当前 Story'),
