...
const _levels = <List<_Spec>>[
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '虽然阿宁要送记录回东边，所以她选择了东侧路线，并在乾清门前会合。', answer: '因为阿宁要送记录回东边，所以她选择了东侧路线，并在乾清门前会合。', options: <String>['因为阿宁要送记录回东边，所以她选择了东侧路线，并在乾清门前会合。','虽然阿宁要送记录回东边，所以她选择了东侧路线，并在乾清门前会合。','虽然阿宁要送记录回东边，但是她选择了东侧路线，并在乾清门前会合。','阿宁要送记录回东边，于是选择了东侧路线，并在乾清门前会合。'], sourceSentence: '因为阿宁要送记录回东边，所以她选择了东侧路线，并在乾清门前会合。', errorSegments: <String>['虽然阿宁要送记录回东边，','所以她选择了','东侧路线，','并在乾清门前会合。'], errorIndex: 0, grammarFamily: '关联词搭配', grammarRule: '原因与结果使用匹配的因果关联。', learning: '辨认关联词搭配', knowledge: '阿宁任务与路线', language: '因为…所以…', reasoning: '判断前后分句的逻辑关系', why: '前句说明原因，后句说明结果，应使用“因为……所以……”。', difficulty: 'Lv2 完整因果', storyEvidence: '她的任务是把记录送回东边，所以她走了另一条路线。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '因为路线清楚、常用，但是沈砚认定它是唯一答案。', answer: '因为路线清楚、常用，所以沈砚认定它是唯一答案。', options: <String>['因为路线清楚、常用，所以沈砚认定它是唯一答案。','因为路线清楚、常用，但是沈砚认定它是唯一答案。','虽然路线清楚、常用，但是沈砚没有把它当成唯一答案。','路线虽然清楚、常用，却不能成为所有任务的唯一答案。'], sourceSentence: '因为路线清楚、常用，所以沈砚认定它是唯一答案。', errorSegments: <String>['因为路线清楚、常用，','但是','沈砚认定','它是唯一答案。'], errorIndex: 1, grammarFamily: '关联关系', grammarRule: '先判断原因、结果、转折，再选择关联词。', learning: '辨认原因与结论', knowledge: '常用路线误判', language: '因果关联', reasoning: '判断逻辑关系', why: '这里是原因导致判断，不是转折。', difficulty: 'Lv3 逻辑关系', storyEvidence: '因为这条路线清楚、常用，他认定它应该成为图上的唯一答案。', knowledgeSource: '当前 Story'),
