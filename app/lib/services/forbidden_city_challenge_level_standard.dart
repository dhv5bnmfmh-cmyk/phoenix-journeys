...
const _levels = <List<_Spec>>[
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '沈砚从午门沿中轴向北走了路线。', answer: '沈砚从午门沿中轴向北走。', options: <String>['沈砚从午门沿中轴向北走。','沈砚从午门沿中轴向北走了路线。','沈砚从午门沿中轴向北走到乾清门。','沈砚从午门沿中轴向北查看路线。'], sourceSentence: '沈砚从午门沿中轴向北走。', errorSegments: <String>['沈砚从午门','沿中轴','向北走了','路线。'], errorIndex: 2, grammarFamily: '动宾搭配', grammarRule: '移动方向表达完整时，不机械添加不自然宾语。', learning: '辨认基础动宾搭配', knowledge: '午门—中轴行动', language: '方向补语', reasoning: '区分自然搭配与机械加宾语', why: '“走了路线”不自然；Story 表达的是沿中轴向北移动。', difficulty: 'Lv1 基础搭配', storyEvidence: '沈砚从午门出发，沿中轴向北走。', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '阿宁把两张路线一起重新看。', answer: '阿宁和沈砚一起重新看两张路线。', options: <String>['阿宁和沈砚一起重新看两张路线。','阿宁把两张路线一起重新看。','阿宁一起把沈砚重新看两张路线。','两张路线和阿宁一起重新看沈砚。'], sourceSentence: '阿宁和沈砚一起重新看两张路线。', errorSegments: <String>['阿宁','把两张路线','一起','重新看。'], errorIndex: 1, grammarFamily: '共同参与者', grammarRule: '“一起”需要写明共同参与者，不能用“把”字句隐藏另一人物。', learning: '补全共同动作的参与者', knowledge: '两人共同核图', language: '和…一起…', reasoning: '从共同事件恢复参与关系', why: 'Story 是两人共同核图，句子必须写出“阿宁和沈砚”这两个参与者。', difficulty: 'Lv1 参与关系', storyEvidence: '两人重新看图。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.sentenceRebuild, prompt: '按语义块复原：新地图增加了什么', answer: '沈砚在两条线上分别写明任务', options: <String>[], sourceSentence: '沈砚在两条线上分别写明任务。', chunks: <String>['沈砚','在两条线上','分别写明任务'], learning: '识别第二章新增的记录动作', knowledge: '路线用途标注', language: '在…上分别…', reasoning: '把人物、载体与新增信息组成事件', why: 'Lv2 的结果不是再次确认地点，而是把不同用途写进路线图。', difficulty: 'Lv2 新事件', storyEvidence: '沈砚把“午前送回东边”写在阿宁的线旁，也在自己的线上标出“观察宫门”。', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '新学徒先决定路线，再看记录要送到哪里。', answer: '新学徒先看记录要送到哪里，再决定路线。', options: <String>['新学徒先看记录要送到哪里，再决定路线。','新学徒先决定路线，再看记录要送到哪里。','新学徒一边决定路线，再看记录要送到哪里。','新学徒看记录要送到哪里，但是先决定路线。'], sourceSentence: '新学徒先看记录要送到哪里，再决定路线。', errorSegments: <String>['新学徒','先决定路线，','再看记录','要送到哪里。'], errorIndex: 1, grammarFamily: '先后顺序', grammarRule: '“先……再……”必须符合证据检查先于路线决定的行动顺序。', learning: '修复行动顺序', knowledge: '任务终点与路线决策', language: '先…再…', reasoning: '根据任务流程排列前后动作', why: '必须先确认记录终点，之后才能选择服务该任务的路线。', difficulty: 'Lv2 程序顺序', storyEvidence: '先看记录要去哪里，再决定走哪条线。', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '沈砚写下两人的目标，也同时又留下两条线。', answer: '沈砚写下两人的目标，也留下两条线。', options: <String>['沈砚写下两人的目标，也留下两条线。','沈砚写下两人的目标，也同时又留下两条线。','沈砚写下两人的目标，同时保留两条线。','沈砚分别写下两人的目标，再留下两条线。'], sourceSentence: '沈砚写下两人的目标，也留下两条线。', errorSegments: <String>['沈砚写下','两人的目标，','也同时又','留下两条线。'], errorIndex: 2, grammarFamily: '成分赘余', grammarRule: '并列或再发生关系只保留必要副词。', learning: '识别副词赘余', knowledge: '人物结局动作', language: '并列关系', reasoning: '删去重复但不改变事件', why: '“也、同时、又”重复表达关系。', difficulty: 'Lv2 简单赘余', storyEvidence: '沈砚写下两人的目标，也留下两条线。', knowledgeSource: '当前 Story'),
    ...
    _Spec(mode: StoryChallengeMode.storyEvidence, prompt: '哪组证据证明旧地图的信息不足，而不是新学徒故意走错？', answer: '图上没有任务说明而记录有午前送回东边的要求', options: <String>['图上没有任务说明而记录有午前送回东边的要求','新学徒从午门进入','沈砚认识周师傅','两条线都画在纸上'], sourceSentence: '旧图没有任务说明，记录却要求午前送回东边。', learning: '区分使用者错误与信息设计缺陷', knowledge: '任务标注、时限证据', language: '而对照', reasoning: '用缺失信息与任务单据共同定位原因', why: '路线图遗漏用途，交接记录又有明确终点与时限，错误来自信息不完整。', difficulty: 'Lv2 双证据诊断', storyEvidence: '没有用途和时限，后来的人仍会把常用线当成指令。', knowledgeSource: '当前 Story'),
    ...
    _Spec(mode: StoryChallengeMode.scenarioDecision, prompt: '新人已经按旧图走到乾清门前，才发现记录必须午前送到东边。此时怎样处理最稳妥？', answer: '依据签记确认剩余时间和终点再改走能按时交接的连接', options: <String>['依据签记确认剩余时间和终点再改走能按时交接的连接','为维护旧图继续原路线','删掉签记上的时限','先争论是谁画错再决定'], sourceSentence: '出现路线与交接要求冲突时，应先用签记确认终点和时限，再调整行动。', learning: '在执行中处理新证据与时限', knowledge: '交接签记、终点、剩余时间', language: '先…再…', reasoning: '用可核对的新证据更新正在执行的方案', why: '本题不是比较抽象任务，而是用签记与剩余时间修正已发生的路线错误。', difficulty: 'Lv2 现场修正', storyEvidence: '三人核对交接签记与两个终点；新学徒按新标记及时完成交接。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '因为路线清楚、常用，但是沈砚认定它是唯一答案。', answer: '因为路线清楚、常用，所以沈砚认定它是唯一答案。', options: <String>['因为路线清楚、常用，所以沈砚认定它是唯一答案。','因为路线清楚、常用，但是沈砚认定它是唯一答案。','虽然路线清楚、常用，但是沈砚没有把它当成唯一答案。','路线虽然清楚、常用，却不能成为所有任务的唯一答案。'], sourceSentence: '因为路线清楚、常用，所以沈砚认定它是唯一答案。', errorSegments: <String>['因为路线清楚、常用，','但是沈砚','认定它是','唯一答案。'], errorIndex: 1, grammarFamily: '关联关系', grammarRule: '先判断原因、结果、转折，再选择关联词。', learning: '辨认原因与结论', knowledge: '常用路线误判', language: '因果关联', reasoning: '判断逻辑关系', why: '这里是原因导致判断，不是转折。', difficulty: 'Lv3 逻辑关系', storyEvidence: '因为这条路线清楚、常用，他认定它应该成为图上的唯一答案。', knowledgeSource: '当前 Story'),
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '阿宁带沈砚回看刚才的位置经过，再核对路线记录。', answer: '阿宁带沈砚回看刚才经过的位置，再核对路线记录。', options: <String>['阿宁带沈砚回看刚才经过的位置，再核对路线记录。','阿宁带沈砚回看刚才的位置经过，再核对路线记录。','阿宁带沈砚回看刚才经过的路线，再核对位置记录。','阿宁带沈砚回看刚才记录的位置，再核对经过路线。'], sourceSentence: '阿宁带沈砚回看刚才经过的位置，再核对路线记录。', errorSegments: <String>['阿宁带沈砚','回看刚才的','位置经过，','再核对路线记录。'], errorIndex: 2, grammarFamily: '定中结构', grammarRule: '修饰语“刚才经过”应放在中心词“位置”之前。', learning: '修复定中结构', knowledge: '回看位置', language: '的字结构', reasoning: '识别修饰语与中心词的关系', why: '“经过”描述的是“位置”，应组成“刚才经过的位置”。', difficulty: 'Lv3 定中结构', storyEvidence: '带沈砚回看刚才经过的几个位置。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '阿宁把自己原先只顾赶路的记录补充得完整了下来，再交给沈砚核对。', answer: '阿宁把自己原先只顾赶路的记录补充完整，再交给沈砚核对。', options: <String>['阿宁把自己原先只顾赶路的记录补充完整，再交给沈砚核对。','阿宁把自己原先只顾赶路的记录补充得完整了下来，再交给沈砚核对。','阿宁把自己原先只顾赶路的记录重新整理，再交给沈砚核对。','阿宁保留自己原先只顾赶路的记录，再请沈砚共同核对。'], sourceSentence: '阿宁把自己原先只顾赶路的记录补充完整，再交给沈砚核对。', errorSegments: <String>['阿宁把自己原先','只顾赶路的记录','补充得完整了下来，','再交给沈砚核对。'], errorIndex: 2, grammarFamily: '结果补语赘余', grammarRule: '结果补语已经表达完成状态，不叠加多余动态与趋向成分。', learning: '识别结果补语赘余', knowledge: '记录补充', language: '把字句与结果补语', reasoning: '删除赘余而保留完成结果', why: '“补充完整”已经表达结果，“得完整了下来”叠加成分使结构拖沓。', difficulty: 'Lv4 结果补语', storyEvidence: '也把自己原先只顾赶路的记录补完整。', knowledgeSource: '当前 Story'),
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '周师傅说新图既能看见建筑，也能看见____。', answer: '人在建筑里为什么这样走', options: <String>['人在建筑里为什么这样走','哪条线画得最粗','谁最先进入午门','所有建筑的颜色'], sourceSentence: '周师傅说新图既能看见建筑，也能看见人在建筑里为什么这样走。', learning: '补全图中新增的解释层', knowledge: '建筑条件与人物动机', language: '既…也…', reasoning: '从图的结果识别结构层与行动理由层', why: '新图的价值是同时解释客观连接和人物选择理由。', difficulty: 'Lv4 双层结果', storyEvidence: '这张图终于既能看见建筑，也能看见人在建筑里为什么这样走。', knowledgeSource: '当前 Story'),
    ...
    _Spec(mode: StoryChallengeMode.scenarioDecision, prompt: '一张图准确画出宫门连接，却没有说明每条线由谁记录。用于交接前还缺什么？', answer: '让各记录者确认自己的观察与标注责任', options: <String>['让各记录者确认自己的观察与标注责任','把所有线改成同一种颜色','只留下最早画出的线','用建筑名称代替记录者确认'], sourceSentence: '交接图除空间准确外，还要保留记录者对其观察的确认。', learning: '把信息责任加入交接判断', knowledge: '记录来源与确认责任', language: '除…外还…', reasoning: '区分内容正确与来源可追溯', why: '空间正确不能替代来源确认；由观察者确认可避免代写或歪曲。', difficulty: 'Lv4 来源责任', storyEvidence: '阿宁把自己原先只顾赶路的记录补完整。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.storyCompletion, prompt: '逐点核对路线时，院落说明哪里相连，____说明哪里可以转向。', answer: '宫门', options: <String>['宫门','画线颜色','人物年龄','纸张大小'], sourceSentence: '逐点核对路线时，院落说明哪里相连，宫门说明哪里可以转向。', learning: '区分两类空间证据的作用', knowledge: '院落连接与宫门转向', language: '并列分工', reasoning: '把建筑要素对应到验证动作', why: 'Story 用院落核对连续关系，用宫门核对转向关系。', difficulty: 'Lv5 证据分类', storyEvidence: '哪里由院落相连，哪里通过宫门转向。', knowledgeSource: '当前 Story / 故宫博物院'),
    ...
    _Spec(mode: StoryChallengeMode.knowledgeReasoning, prompt: '为什么核对路线时不能把“院落相连”和“宫门可转向”当成同一种证据？', answer: '前者证明连续空间后者证明方向转换的入口', options: <String>['前者证明连续空间后者证明方向转换的入口','两者都只证明路线颜色','院落决定人物任务宫门决定人物年龄','两者都能单独证明任何路线正确'], sourceSentence: '院落连续与宫门转向回答不同的空间问题。', learning: '理解空间证据分工', knowledge: '院落、宫门', language: '前者…后者…', reasoning: '按证据能证明的命题分类', why: '连续关系和转向入口是两个不同的可核查命题。', difficulty: 'Lv5 证据边界', storyEvidence: '哪里由院落相连，哪里通过宫门转向。', knowledgeSource: '故宫博物院 / 当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.scenarioDecision, prompt: '史料图显示一座宫门与目标区域相连，但通行记录表明当时你的身份不得进入。结论应是什么？', answer: '空间连接成立但该历史条件下不能采用这条路线', options: <String>['空间连接成立但该历史条件下不能采用这条路线','地图相连就证明任何人都能通行','身份限制会让建筑连接消失','忽略史料只按最短距离走'], sourceSentence: '物理连接和历史通行资格必须分别检验。', learning: '区分空间事实与制度许可', knowledge: '建筑连接、身份与礼制', language: '但结构', reasoning: '用两类证据形成受条件限制的结论', why: '建筑证明哪里相连，通行记录决定特定身份在当时是否可用。', difficulty: 'Lv6 制度条件', storyEvidence: '空间能不能连接，路线是不是适合这个人的任务。', knowledgeSource: '故宫博物院·午门 / 景运门 / 隆宗门'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '两人面对的是同一组建筑约束，却从不同任务与视角作出了选择不同。', answer: '两人面对的是同一组建筑约束，却从不同任务与视角作出不同选择。', options: <String>['两人面对的是同一组建筑约束，却从不同任务与视角作出不同选择。','两人面对的是同一组建筑约束，却从不同任务与视角作出了选择不同。','两人面对的是同一组建筑约束，也会依据各自任务选择路线。','两人面对的是同一组建筑约束，但各自视角影响了路线选择。'], sourceSentence: '两人面对的是同一组建筑约束，却从不同任务与视角作出不同选择。', errorSegments: <String>['两人面对的是','同一组建筑约束，','却从不同任务与视角','作出了选择不同。'], errorIndex: 3, grammarFamily: '语序搭配', grammarRule: '修饰成分放在真正限定的中心词前。', learning: '修复复杂句语序', knowledge: '共同约束与不同选择', language: '作出不同选择', reasoning: '根据搭配确定修饰位置', why: '“不同”应修饰“选择”。', difficulty: 'Lv7 复杂语序', storyEvidence: '却从不同任务与视角作出选择。', knowledgeSource: '当前 Story'),
  ...
  <_Spec>[
    ...
    _Spec(mode: StoryChallengeMode.grammarRepair, prompt: '两人的合作方式开始转变成为了由双方提供证据，再共同核对路线。', answer: '两人的合作方式开始转变为由双方提供证据，再共同核对路线。', options: <String>['两人的合作方式开始转变为由双方提供证据，再共同核对路线。','两人的合作方式开始转变成为了由双方提供证据，再共同核对路线。','两人的合作方式逐渐变成双方提供证据，再共同核对路线。','两人的合作方式不再是谁纠正谁，而是双方共同核对路线。'], sourceSentence: '两人的合作方式开始转变为由双方提供证据，再共同核对路线。', errorSegments: <String>['两人的合作方式','开始转变成为了','由双方提供证据，','再共同核对路线。'], errorIndex: 1, grammarFamily: '动态成分', grammarRule: '变化动词已经完整时，不机械叠加动态成分。', learning: '修复抽象变化句', knowledge: '合作方式', language: '转变为', reasoning: '判断动态成分必要性', why: '“转变为”已完整表达变化，“成为了”叠加动态成分使结构拖沓。', difficulty: 'Lv8 抽象表达', storyEvidence: '合作从“谁纠正谁”变成“谁提供哪一种证据”。', knowledgeSource: '当前 Story'),
  ...
  for (var index = 0; index < specs.length; index += 1) {
    ...
    final rationales = <String>[
      for (final option in options)
        option == spec.answer
            ? '正确：$whyCorrect'
            : _optionSpecificRationale(spec, option),
    ];
    questions.add(
...
String _optionSpecificRationale(_Spec spec, String option) {
  final quoted = '“$option”';
  if (option == spec.prompt) {
    return '$quoted保留了题干中的原错误，没有按“${spec.grammarRule ?? spec.language}”完成修正。';
  }
  if (RegExp(r'一定|唯一|所有|完全|自动|永远|只要').hasMatch(option) &&
      !RegExp(r'一定|唯一|所有|完全|自动|永远|只要').hasMatch(spec.answer)) {
    return '$quoted把结论扩大成绝对判断；现有“${spec.storyEvidence}”只能支持有条件的结论。';
  }
  if (RegExp(r'删|取消|不看|无视|随意|随机|错误|禁止').hasMatch(option)) {
    return '$quoted跳过或排除了题目要求核对的“${spec.knowledge}”，因此不能完成“${spec.reasoning}”。';
  }
  if (spec.mode == StoryChallengeMode.grammarRepair) {
    return '$quoted虽然句子表面通顺，但改变了原事件关系；本题须保留“${spec.storyEvidence}”并应用“${spec.grammarRule}”。';
  }
  if (spec.mode == StoryChallengeMode.storyEvidence ||
      spec.mode == StoryChallengeMode.storyCompletion) {
    return '$quoted没有出现在本题所依据的“${spec.storyEvidence}”中，不能支持“${spec.learning}”。';
  }
  if (spec.mode == StoryChallengeMode.knowledgeReasoning) {
    return '$quoted与“${spec.knowledgeSource}”提供的“${spec.knowledge}”事实不符，无法推出正确结论。';
  }
  return '$quoted没有执行“${spec.reasoning}”；它忽略了当前情境中的“${spec.storyEvidence}”。';
}
  ...
  if (spec.mode == StoryChallengeMode.grammarRepair) {
    if (spec.errorSegments.length != 4 ||
        ...
        spec.errorSegments.any((segment) =>
            !isMeaningfulGrammarSegment(segment)) ||
...
bool isMeaningfulGrammarSegment(String value) {
...
bool hasTrivialGrammarFragmentationLeak(
  ...
  return segments
      ...
      .every((entry) => isMeaningfulGrammarSegment(entry.value));
}
