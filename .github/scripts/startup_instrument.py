...
if candidate_arch:
    location = replace_one(location, "JourneyLocationBinding _buildSelectedJourneyLocationBinding(\n  DailyJourneyExperience journey,\n) {\n  final node =", "JourneyLocationBinding _buildSelectedJourneyLocationBinding(\n  DailyJourneyExperience journey,\n) {\n  startupPerformanceMark('phoenix-location-bindings-start');\n  final node =", 'selected binding start')
    location = replace_one(location, "  return JourneyLocationBinding(\n    journey: journey,\n    placeNode: node,\n    geoPath: List<GeoNode>.unmodifiable(geoPath),\n  );\n}\n\nMap<String, JourneyLocationBinding> buildJourneyLocationBindingsForValidation", "  final binding = JourneyLocationBinding(\n    journey: journey,\n    placeNode: node,\n    geoPath: List<GeoNode>.unmodifiable(geoPath),\n  );\n  startupPerformanceMark('phoenix-location-bindings-end');\n  return binding;\n}\n\nMap<String, JourneyLocationBinding> buildJourneyLocationBindingsForValidation", 'selected binding end')
else:
