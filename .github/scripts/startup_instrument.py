...
if candidate_arch:
    location = replace_one(location, "JourneyLocationBinding requireJourneyLocation(String journeyId) {\n  final cached =", "JourneyLocationBinding requireJourneyLocation(String journeyId) {\n  startupPerformanceMark('phoenix-location-bindings-start');\n  final cached =", 'selected binding start')
    location = replace_one(location, "  _journeyLocationBindingCache[journeyId] = binding;\n  return binding;\n}", "  _journeyLocationBindingCache[journeyId] = binding;\n  startupPerformanceMark('phoenix-location-bindings-end');\n  return binding;\n}", 'selected binding end')
else:
