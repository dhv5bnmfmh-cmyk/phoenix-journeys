...
replacement = """final chengduStoryParagraphs = <String>[
...
for helper in [
    ".github/workflows/chengdu-legacy-adapter-fix.yml",
    ".github/workflows/chengdu-integration-repair.yml",
    ".github/workflows/chengdu-adapter-repair.yml",
    ".github/workflows/chengdu-adapter-repair-v2.yml",
    ".github/workflows/chengdu-adapter-repair-v3.yml",
    ".github/workflows/chengdu-adapter-repair-v4.yml",
    ".github/scripts/chengdu_adapter_repair.py",
]:
