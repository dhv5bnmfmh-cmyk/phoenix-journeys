# Phoenix global current-standard compliance

Audit baseline: `e3d1f30b951d6ab27d7660b9b729d4f8af9a8d49`

## Deterministic inventories

- Current effective standard documents: **23**
- Extracted explicit normative clauses: **780**
- Objectively verifiable clauses: **658**
- Clauses requiring legitimate human/Founder evidence: **122**
- Active Journeys: **36** (27 normal + 9 special)
- Current Approved Gold: **14**
- Gold candidates: **1** (`pingyao-ancient-city`)
- Requirement × Journey rows: **28080**
- Current Approved-Gold Challenge units: **420**
