...
| 5 | beijing-summer-palace | chengdu-kuanzhai-alley | NO | none | 0 | none | VERIFIED | DISTINCT | Threatened relational keepsake/creative tradeoff vs repeated temporary handoffs that keep shared courtyard space usable. |
...
| 10 | beijing-forbidden-city | chengdu-kuanzhai-alley | NO | none | 0 | none | VERIFIED | DISTINCT | Composite preservation of two valid representations vs temporal physical handoff of one shared-use object. |
| 11 | beijing-forbidden-city | nanjing-qinhuai-river | NO | none | 0 | none | VERIFIED | DISTINCT | Forbidden aligns and preserves two valid routes; Nanjing remains responsible refusal of an unsafe/unapproved shortcut. |
...
| 14 | shanghai-bund | chengdu-kuanzhai-alley | NO | none | 0 | none | VERIFIED | DISTINCT | Carried trade-document continuity through a one-way crossing vs repeated shared-space yield-and-return behavior. |
...
| 17 | xian-city-wall | chengdu-kuanzhai-alley | NO | none | 0 | none | VERIFIED | DISTINCT | Completed farewell circuit becoming open continuation vs repeated handoff among current shared-space users. |
...
Forbidden City uses `coexistingValidPerspectivesSynthesizeRelationalModel`; Nanjing remains a responsible-refusal engine. Their prior collision remains remediated.
