...
const catalog = readFileSync(
  new URL('../app/lib/data/journey_expansion_batch_three.dart', import.meta.url),
  'utf8',
);
...
const journeys = [
  ['dunhuang-mogao-caves', '敦煌', '莫高窟'],
  ['chengde-mountain-resort', '承德', '避暑山庄'],
  ['xiamen-kulangsu', '厦门', '鼓浪屿'],
];

test('third expansion batch follows journey and passport contracts', () => {
...
test('every third-batch journey has UNESCO and government verification', () => {
  assert.equal(
