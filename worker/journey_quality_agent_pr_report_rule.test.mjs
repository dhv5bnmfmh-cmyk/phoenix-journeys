...
test('Flutter-backed runner requires eighteen journeys and 180 inspections', () => {
  ...
  assert.match(reportRunner, /report\['journeyCount'\], 18/);
  assert.match(reportRunner, /report\['specialJourneyCount'\], 4/);
  assert.match(reportRunner, /report\['inspectionCount'\], 180/);
