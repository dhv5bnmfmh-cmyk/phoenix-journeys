...
test('Story progression and stage closure resolve canonical scenes', () => {
  ...
  assert.match(journey, /progress < \.22[\s\S]*FC01-A/);
  assert.match(journey, /progress < \.48[\s\S]*FC01-B/);
  assert.match(journey, /progress < \.76[\s\S]*FC01-C/);
  assert.match(journey, /return 'FC01-D'/);
